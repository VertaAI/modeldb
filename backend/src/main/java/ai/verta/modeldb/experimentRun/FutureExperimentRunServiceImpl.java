...
public class FutureExperimentRunServiceImpl extends ExperimentRunServiceImpl {
  ...
  private InternalFuture<Boolean> addEvent(
      String entityId,
                        ...
                        .thenCompose(
                            userInfo -> {
                              ...
                              return addEvent(
                                  ...
                                  UPDATE_EVENT_TYPE,
                                  Optional.of("observations"),
                                  Collections.singletonMap("observations", extraField),
                        ...
                        .thenCompose(
                            userInfo -> {
                              ...
                              return addEvent(
                                  ...
                                  UPDATE_EVENT_TYPE,
                                  Optional.of("metrics"),
                                  Collections.singletonMap("metrics", extraField),
                        ...
                        .thenCompose(
                            userInfo -> {
                              ...
                              return addEvent(
                                  ...
                                  UPDATE_EVENT_TYPE,
                                  Optional.of("hyperparameters"),
                                  Collections.singletonMap("hyperparameters", extraField),
                        ...
                        .thenCompose(
                            userInfo -> {
                              ...
                              return addEvent(
                                  ...
                                  UPDATE_EVENT_TYPE,
                                  Optional.of("attributes"),
                                  Collections.singletonMap("attributes", extraField),

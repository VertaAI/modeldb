package ai.verta.modeldb.name_generator;

import java.util.Random;

/**
 * MobyNames(https://github.com/moby/moby/tree/master) is a Java port of the Moby Project random
 * name generator Java: (https://github.com/googlielmo/mobynames)
 */
public class NamesGenerator {
  ...
  // Please, for any amazing man that you add to the list, consider adding an equally amazing woman
  ...
  private static final String[] right = {
    ...
    // Kathleen Antonelli, American computer programmer and one of the six original programmers of
    // the ENIAC - https://en.wikipedia.org/wiki/Kathleen_Antonelli
    "antonelli",

    // Maria Gaetana Agnesi - Italian mathematician, philosopher, theologian and humanitarian. She
    // was the first woman to write a mathematics handbook and the first woman appointed as a
    ...
    // Buckaroo Banzai and his mentor Dr. Hikita perfectd the "oscillation overthruster", a device
    ...
    // Homi J Bhabha - was an Indian nuclear physicist, founding director, and professor of physics
    // at the Tata Institute of Fundamental Research. Colloquially known as "father of Indian
    // nuclear programme"- https://en.wikipedia.org/wiki/Homi_J._Bhabha
    "bhabha",

    // Bhaskara II - Ancient Indian mathematician-astronomer whose work on calculus predates Newton
    // and Leibniz by over half a millennium -
    ...
    // Satyendra Nath Bose - He provided the foundation for Bose–Einstein statistics and the theory
    // of the Bose–Einstein condensate. - https://en.wikipedia.org/wiki/Satyendra_Nath_Bose
    "bose",
    ...
    // Dame Susan Jocelyn Bell Burnell - discoverer of pulsars while a graduate student, "one of the
    // most significant scientific achievements of the 20th Century". -
    ...
    // Sergey Alexeyevich Chaplygin (Russian: Серге́й Алексе́евич Чаплы́гин; April 5, 1869 – October
    // 8, 1942) was a Russian and Soviet physicist, mathematician, and mechanical engineer. He is
    // known for mathematical formulas such as Chaplygin's equation and for a hypothetical substance
    ...
    // Clifford Christopher Cocks - British mathematician and cryptographer employed by the GCHQ.
    // Invented in 1973 an equivalent of what is now known as the RSA public-key cryptosystem
    // (Rivest, Shamir and Adleman first publicly described RSA in 1978).
    ...
    // woman—to win a Nobel Prize in science, and the first woman to be awarded the Nobel Prize in
    // Physiology or Medicine. Cori was born in Prague. https://en.wikipedia.org/wiki/Gerty_Cori
    "cori",
    ...
    // Samuel Curran was an Irish physicist who worked alongside his wife during WWII and invented
    ...
    // Author of Core War (program), The Planiverse, The Armchair Universe, The Magic Machine, The
    // New Turing Omnibus, and more. https://en.wikipedia.org/wiki/Alexander_Dewdney
    "dewdney",
    ...
    // cipher machines of the US Navy, the CM. https://en.wikipedia.org/wiki/Agnes_Meyer_Driscoll
    "driscoll",
    ...
    // graduate student, computer programmer, internet pirate in hiding, and the creator of the site
    // Sci-Hub. Nature has listed her in 2016 in the top ten people that mattered in science, and
    ...
    // Prize in Medicine - https://en.wikipedia.org/wiki/Gertrude_Elion
    "elion",
    ...
    // fields, including number theory, algebra, statistics, analysis, differential geometry,
    // geodesy, geophysics, mechanics, electrostatics, magnetic fields, astronomy, matrix theory,
    // and optics. https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss
    "gauss",
    ...
    // Caroline Harriet Haslett - English electrical engineer, electricity industry administrator
    // and champion of women's rights. Co-author of British Standard 1363 that specifies AC power
    // plugs and sockets used across the United Kingdom (which is widely considered as one of the
    ...
    // electroanalytical method, and recipient of the Nobel Prize in 1959. His main field of work
    // was polarography. https://en.wikipedia.org/wiki/Jaroslav_Heyrovsk%C3%BD
    "heyrovsky",
    ...
    // Pulitzer Prize and American Book Award-winning work Goedel, Escher, Bach: An Eternal Golden
    // Braid in 1979. A mind-bending work which coined Hofstadter's Law: "It always takes longer
    ...
    // understanding of semiconductors, integrated circuitry, and the unique electrical principles
    // of microscopic materials. https://en.wikipedia.org/wiki/Frances_Hugle
    "hugle",
    ...
    // within NASA's engineering department - https://en.wikipedia.org/wiki/Mary_Jackson_(engineer)
    "jackson",

    // Yeong-Sil Jang was a Korean scientist and astronomer during the Joseon Dynasty; he invented
    // the first metal printing press and water gauge. https://en.wikipedia.org/wiki/Jang_Yeong-sil
    "jang",
    ...
    // NASA. https://en.wikipedia.org/wiki/Katherine_Johnson
    "johnson",
    ...
    // 2012) was a Russian physicist and demographer. He was best known as host of the popular and
    ...
    // Director. https://en.wikipedia.org/wiki/Susan_Kare
    "kare",

    // Mstislav Keldysh - a Soviet scientist in the field of mathematics and mechanics, academician
    // of the USSR Academy of Sciences (1946), President of the USSR Academy of Sciences
    // (1961–1975), three times Hero of Socialist Labor (1956, 1961, 1971), fellow of the Royal
    // Society of Edinburgh (1968). https://en.wikipedia.org/wiki/Mstislav_Keldysh
    "keldysh",
    ...
    // modern Wi-Fi, CDMA and Bluetooth technology. https://en.wikipedia.org/wiki/Hedy_Lamarr
    "lamarr",

    // Leslie B. Lamport - American computer scientist. Lamport is best known for his seminal work
    // in distributed systems and was the winner of the 2013 Turing Award.
    ...
    // Henrietta Swan Leavitt - she was an American astronomer who discovered the relation between
    // the luminosity and the period of Cepheid variable stars.
    ...
    // optimization techniques for routing traffic on the internet. Died attempting to stop the 9-11
    // hijackers. https://en.wikipedia.org/wiki/Daniel_Lewin
    "lewin",
    ...
    // Barbara Liskov - co-developed the Liskov substitution principle. Liskov was also the winner
    // of the Turing Prize in 2008. - https://en.wikipedia.org/wiki/Barbara_Liskov
    "liskov",
    ...
    // human in-vitro fertilisation. https://en.wikipedia.org/wiki/Anne_McLaren
    "mclaren",
    ...
    // farsighted version of the periodic table of elements, and used it to correct the properties
    // of some already discovered elements and also to predict the properties of eight elements yet
    // to be discovered. https://en.wikipedia.org/wiki/Dmitri_Mendeleev
    "mendeleev",
    ...
    // Ralph C. Merkle - American computer scientist, known for devising Merkle's puzzles - one of
    // the very first schemes for public-key cryptography. Also, inventor of Merkle trees and
    // co-inventor of the Merkle-Damgård construction for building collision-resistant cryptographic
    // hash functions and the Merkle-Hellman knapsack cryptosystem.
    ...
    // Germany - https://en.wikipedia.org/wiki/Johanna_Mestorf
    "mestorf",

    // Marvin Minsky - Pioneer in Artificial Intelligence, co-founder of the MIT's AI Lab, won the
    // Turing Award in 1969. https://en.wikipedia.org/wiki/Marvin_Minsky
    "minsky",
    ...
    // law. https://en.wikipedia.org/wiki/Gordon_Moore
    "moore",
    ...
    // Alfred Nobel - a Swedish chemist, engineer, innovator, and armaments manufacturer (inventor
    // of dynamite) - https://en.wikipedia.org/wiki/Alfred_Nobel
    "nobel",
    ...
    // Control. http://www.businessinsider.com/poppy-northcutt-helped-apollo-astronauts-2014-12?op=1
    "northcutt",
    ...
    // of hydrogen and helium. https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin
    "payne",

    // Radia Perlman is a software designer and network engineer and most famous for her invention
    // of the spanning-tree protocol (STP). https://en.wikipedia.org/wiki/Radia_Perlman
    "perlman",
    ...
    // tools, advances the causes of truth and freedom of information by reporting disclosures by
    ...
    // effect. - https://en.wikipedia.org/wiki/C._V._Raman
    "raman",
    ...
    // in space, and the youngest American astronaut. https://en.wikipedia.org/wiki/Sally_Ride
    "ride",
    ...
    // critical to the understanding of DNA - https://en.wikipedia.org/wiki/Rosalind_Franklin
    "rosalind",
    ...
    // theory. (https://en.wikipedia.org/wiki/Claude_Shannon)
    "shannon",

    // Carol Shaw - Originally an Atari employee, Carol Shaw is said to be the first female video
    // game designer. https://en.wikipedia.org/wiki/Carol_Shaw_(video_game_designer)
    "shaw",
    ...
    // thousands of lives at the fronts of World War II. She is best known for her pioneering work
    // on blood–brain barrier, which she described as hemato-encephalic barrier in 1921.
    ...
    // Richard Matthew Stallman - the founder of the Free Software movement, the GNU project, the
    // Free Software Foundation, and the League for Programming Freedom. He also invented the
    // concept of copyleft to protect the ideals of this movement, and enshrined this concept in the
    ...
    // quantum theory. https://en.wikipedia.org/wiki/Bertha_Swirles
    "swirles",

    // Helen Brooke Taussig - American cardiologist and founder of the field of paediatric
    // cardiology. https://en.wikipedia.org/wiki/Helen_B._Taussig
    "taussig",
    ...
    // Indian Republic's highest honour, the Bharat Ratna, in 1955. On his birthday, 15 September is
    ...
    // to nuclear physics. https://en.wikipedia.org/wiki/Chien-Shiung_Wu
    "wu",
    ...
    // Nikolay Yegorovich Zhukovsky (Russian: Никола́й Его́рович Жуко́вский, January 17 1847 – March
    // 17, 1921) was a Russian scientist, mathematician and engineer, and a founding father of
    // modern aero- and hydrodynamics. Whereas contemporary scientists scoffed at the idea of human
    // flight, Zhukovsky was the first to undertake the study of airflow. He is often called the
    // Father of Russian Aviation. https://en.wikipedia.org/wiki/Nikolay_Yegorovich_Zhukovsky
    "zhukovsky",
  };
  ...
  public static String getRandomName(int retry) {
    ...
    do {
      name =
          String.format(
              "%s_%s", left[random.nextInt(left.length)], right[random.nextInt(right.length)]);

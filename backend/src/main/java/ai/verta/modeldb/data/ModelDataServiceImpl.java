...
public class ModelDataServiceImpl extends ModelDataServiceGrpc.ModelDataServiceImplBase {
  ...
  private Map<String, Object> buildDiffPayload(
    ...
    final long predictionCountA = ((AtomicLong) aggregateA.get("predictionCount")).get();
    final long predictionCountB = ((AtomicLong) aggregateB.get("predictionCount")).get();
            ...
            pair -> {
              ...
              try {
                ...
                final Long populationSize =
                    ((Double) rootObject.get("population_size")).longValue();
                final Long predictionCount =
                    ((Double) rootObject.get("prediction_count")).longValue();

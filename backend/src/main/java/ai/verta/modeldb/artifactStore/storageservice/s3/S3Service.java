...
public class S3Service implements ArtifactStoreService {
  ...
  public GetUrlForArtifact.Response generatePresignedUrlForTrial(
    ...
    if (mdbConfig.mdbArtifactStoreConfig.S3.s3presignedURLEnabled) {
          ...
          return GetUrlForArtifact.Response.newBuilder()
              ...
              .putAllFields(
                  TrialUtils.getBodyParameterMapForTrialPresignedURL(
                      ...
                      bucketName,
                      mdbConfig.mdbArtifactStoreConfig.S3.awsRegion,
                      s3Key,
  ...
  public String getPresignedUrlViaMDB(
    ...
    if (method.equalsIgnoreCase(ModelDBConstants.PUT)) {
      ...
      final var url =
          getUploadUrl(
              parameters,
              mdbConfig.mdbArtifactStoreConfig.protocol,
              mdbConfig.mdbArtifactStoreConfig.artifactEndpoint.storeArtifact,
              mdbConfig.mdbArtifactStoreConfig.pickArtifactStoreHostFromConfig,
              mdbConfig.mdbArtifactStoreConfig.host);
      ...
      final var url =
          getDownloadUrl(
              parameters,
              mdbConfig.mdbArtifactStoreConfig.protocol,
              mdbConfig.mdbArtifactStoreConfig.artifactEndpoint.getArtifact,
              mdbConfig.mdbArtifactStoreConfig.pickArtifactStoreHostFromConfig,
              mdbConfig.mdbArtifactStoreConfig.host);
      LOGGER.debug("S3Service - generatePresignedUrl - returning URL " + url);
      return url;

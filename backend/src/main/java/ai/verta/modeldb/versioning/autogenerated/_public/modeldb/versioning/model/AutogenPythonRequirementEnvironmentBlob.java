...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenPythonRequirementEnvironmentBlob setConstraint(String
 value) {
 ...
 getConstraint() {
    ...
    public AutogenPythonRequirementEnvironmentBlob setLibrary(String
 value) {
 ...
 getLibrary() {
    ...
    public AutogenPythonRequirementEnvironmentBlob setVersion(AutogenVersionEnvironmentBlob
 value) {
 ...
 getVersion() {
    ...
    static public AutogenPythonRequirementEnvironmentBlob fromProto(ai.verta.modeldb.versioning.PythonRequirementEnvironmentBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.PythonRequirementEnvironmentBlob,String
> f = x -> (blob.getConstraint());
...
> f = x -> (blob.getLibrary());
        ...
        {
            Function<ai.verta.modeldb.versioning.PythonRequirementEnvironmentBlob,AutogenVersionEnvironmentBlob
...
(this.Version);
    ...
    public AutogenPythonRequirementEnvironmentBlob postVisitShallow(Visitor visitor) throws ModelDBException {
        return visitor.postVisitAutogenPythonRequirementEnvironmentBlob(this);
    }

    public AutogenPythonRequirementEnvironmentBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setConstraint(visitor.postVisitDeepString
(this.Constraint));
        this.setLibrary(visitor.postVisitDeepString
(this.Library));

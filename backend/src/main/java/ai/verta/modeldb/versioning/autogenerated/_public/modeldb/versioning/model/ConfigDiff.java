...
public class ConfigDiff implements ProtoType {
    ...
    public ConfigDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setHyperparameterSet(visitor.postVisitDeepListOfHyperparameterSetConfigDiff(this.HyperparameterSet));
        this.setHyperparameters(visitor.postVisitDeepListOfHyperparameterConfigDiff(this.Hyperparameters));

...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenDockerEnvironmentBlob setRepository(String
 value) {
 ...
 getRepository() {
    ...
    public AutogenDockerEnvironmentBlob setSha(String
 value) {
 ...
 getSha() {
    ...
    public AutogenDockerEnvironmentBlob setTag(String
 value) {
 ...
 getTag() {
    ...
    static public AutogenDockerEnvironmentBlob fromProto(ai.verta.modeldb.versioning.DockerEnvironmentBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.DockerEnvironmentBlob,String
> f = x -> (blob.getRepository());
...
(this.Tag);
    ...
    public AutogenDockerEnvironmentBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setRepository(visitor.postVisitDeepString
(this.Repository));
        this.setSha(visitor.postVisitDeepString
(this.Sha));

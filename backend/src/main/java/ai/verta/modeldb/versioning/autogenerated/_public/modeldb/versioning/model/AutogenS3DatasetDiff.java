...
public class AutogenS3DatasetDiff implements ProtoType {
    private List<AutogenS3DatasetComponentDiff
>
 Components;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<List<AutogenS3DatasetComponentDiff
>
,List<AutogenS3DatasetComponentDiff
>
,Boolean> f = (x2, y2) -> IntStream.range(0, Math.min(x2.size(), y2.size())).mapToObj(i -> { Function3<AutogenS3DatasetComponentDiff
...
,Boolean> f2 = (x, y) -> x.equals(y); return f2.apply(x2.get(i), y2.get(i));}).filter(x -> x.equals(false)).collect(Collectors.toList()).isEmpty();
    ...
    public AutogenS3DatasetDiff setComponents(List<AutogenS3DatasetComponentDiff
>
 value) {
        this.Components = Utils.removeEmpty(value);
        if (this.Components != null) {
            this.Components.sort(Comparator.comparingInt(AutogenS3DatasetComponentDiff
::hashCode));
        }
        return this;
    }
    public List<AutogenS3DatasetComponentDiff
>
 getComponents() {
        return this.Components;
    }

    static public AutogenS3DatasetDiff fromProto(ai.verta.modeldb.versioning.S3DatasetDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.S3DatasetDiff,List<AutogenS3DatasetComponentDiff
>
> f = x -> blob.getComponentsList().stream().map(AutogenS3DatasetComponentDiff::fromProto).collect(Collectors.toList());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepListOfAutogenS3DatasetComponentDiff
...
(this.Components);
    ...
    public AutogenS3DatasetDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setComponents(visitor.postVisitDeepListOfAutogenS3DatasetComponentDiff

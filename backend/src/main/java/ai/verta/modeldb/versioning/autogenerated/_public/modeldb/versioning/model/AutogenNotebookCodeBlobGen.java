...
public class AutogenNotebookCodeBlobGen extends Generator<AutogenNotebookCodeBlob> {
    ...
    @Override public AutogenNotebookCodeBlob generate(
            ...
            GenerationStatus status) {
                ...
                if (r.nextBoolean()) {
                    obj.setGitRepo(Utils.removeEmpty(gen().type(AutogenGitCodeBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setPath(Utils.removeEmpty(gen().type(AutogenPathDatasetComponentBlob
.class).generate(r, status)));
                }
                return obj;
    }

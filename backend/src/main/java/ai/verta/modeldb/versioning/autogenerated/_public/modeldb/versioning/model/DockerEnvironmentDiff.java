...
public class DockerEnvironmentDiff implements ProtoType {
    ...
    public Boolean equals(DockerEnvironmentDiff other) {
        if (other == null) {
            return false;
        }
        {
    ...
    static public DockerEnvironmentDiff fromProto(ai.verta.modeldb.versioning.DockerEnvironmentDiff blob) {
        ...
        {
            Function<ai.verta.modeldb.versioning.DockerEnvironmentDiff,DiffStatusEnumDiffStatus> f = x -> DiffStatusEnumDiffStatus.fromProto(blob.getStatus());

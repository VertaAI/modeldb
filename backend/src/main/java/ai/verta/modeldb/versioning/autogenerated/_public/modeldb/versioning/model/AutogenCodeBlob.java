...
public class AutogenCodeBlob implements ProtoType {
 ...
 Git;
    private AutogenNotebookCodeBlob
 Notebook;
...
,Boolean> f = (x, y) -> x.equals(y);
        ...
        {
            Function3<AutogenNotebookCodeBlob
,AutogenNotebookCodeBlob
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenCodeBlob setGit(AutogenGitCodeBlob
 value) {
 ...
 getGit() {
    ...
    public AutogenCodeBlob setNotebook(AutogenNotebookCodeBlob
 value) {
 ...
 getNotebook() {
    ...
    static public AutogenCodeBlob fromProto(ai.verta.modeldb.versioning.CodeBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.CodeBlob,AutogenGitCodeBlob
> f = x -> AutogenGitCodeBlob.fromProto(blob.getGit());
            obj.setGit(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.CodeBlob,AutogenNotebookCodeBlob
> f = x -> AutogenNotebookCodeBlob.fromProto(blob.getNotebook());
...
(this.Git);
        visitor.preVisitDeepAutogenNotebookCodeBlob
(this.Notebook);
    }
    ...
    public AutogenCodeBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setGit(visitor.postVisitDeepAutogenGitCodeBlob
(this.Git));
        this.setNotebook(visitor.postVisitDeepAutogenNotebookCodeBlob
(this.Notebook));

...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenVersionEnvironmentBlob setMajor(Integer
 value) {
 ...
 getMajor() {
    ...
    public AutogenVersionEnvironmentBlob setMinor(Integer
 value) {
 ...
 getMinor() {
    ...
    public AutogenVersionEnvironmentBlob setPatch(Integer
 value) {
 ...
 getPatch() {
    ...
    public AutogenVersionEnvironmentBlob setSuffix(String
 value) {
 ...
 getSuffix() {
    ...
    static public AutogenVersionEnvironmentBlob fromProto(ai.verta.modeldb.versioning.VersionEnvironmentBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.VersionEnvironmentBlob,Integer
> f = x -> (blob.getMajor());
...
> f = x -> (blob.getPatch());
        ...
        {
            Function<ai.verta.modeldb.versioning.VersionEnvironmentBlob,String
> f = x -> (blob.getSuffix());
...
(this.Suffix);
    ...
    public AutogenVersionEnvironmentBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setMajor(visitor.postVisitDeepInteger
(this.Major));
        this.setMinor(visitor.postVisitDeepInteger
(this.Minor));
        this.setPatch(visitor.postVisitDeepInteger
(this.Patch));
        this.setSuffix(visitor.postVisitDeepString
(this.Suffix));

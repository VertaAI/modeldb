...
public class AutogenPythonRequirementEnvironmentDiff implements ProtoType {
    private AutogenPythonRequirementEnvironmentBlob
 A;
    private AutogenPythonRequirementEnvironmentBlob
 B;
    private AutogenPythonRequirementEnvironmentBlob
 ...
 Status;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<AutogenPythonRequirementEnvironmentBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenPythonRequirementEnvironmentDiff setA(AutogenPythonRequirementEnvironmentBlob
 value) {
 ...
 getA() {
    ...
    public AutogenPythonRequirementEnvironmentDiff setB(AutogenPythonRequirementEnvironmentBlob
 value) {
 ...
 getB() {
    ...
    public AutogenPythonRequirementEnvironmentDiff setC(AutogenPythonRequirementEnvironmentBlob
 value) {
 ...
 getC() {
    ...
    public AutogenPythonRequirementEnvironmentDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenPythonRequirementEnvironmentDiff fromProto(ai.verta.modeldb.versioning.PythonRequirementEnvironmentDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.PythonRequirementEnvironmentDiff,AutogenPythonRequirementEnvironmentBlob
...
> f = x -> AutogenPythonRequirementEnvironmentBlob.fromProto(blob.getC());
        ...
        {
            Function<ai.verta.modeldb.versioning.PythonRequirementEnvironmentDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.PythonRequirementEnvironmentDiff.Builder toProto() {
        ...
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.PythonRequirementEnvironmentDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenPythonRequirementEnvironmentBlob
(this.A);
        visitor.preVisitDeepAutogenPythonRequirementEnvironmentBlob
(this.B);
        visitor.preVisitDeepAutogenPythonRequirementEnvironmentBlob
...
(this.Status);
    ...
    public AutogenPythonRequirementEnvironmentDiff postVisitShallow(Visitor visitor) throws ModelDBException {
        return visitor.postVisitAutogenPythonRequirementEnvironmentDiff(this);
    }

    public AutogenPythonRequirementEnvironmentDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenPythonRequirementEnvironmentBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenPythonRequirementEnvironmentBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenPythonRequirementEnvironmentBlob
(this.C));

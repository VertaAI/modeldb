...
public class AutogenHyperparameterConfigDiff implements ProtoType {
    private AutogenHyperparameterConfigBlob
 A;
    private AutogenHyperparameterConfigBlob
 B;
    private AutogenHyperparameterConfigBlob
 ...
 Status;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<AutogenHyperparameterConfigBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenHyperparameterConfigDiff setA(AutogenHyperparameterConfigBlob
 value) {
 ...
 getA() {
    ...
    public AutogenHyperparameterConfigDiff setB(AutogenHyperparameterConfigBlob
 value) {
 ...
 getB() {
    ...
    public AutogenHyperparameterConfigDiff setC(AutogenHyperparameterConfigBlob
 value) {
 ...
 getC() {
    ...
    public AutogenHyperparameterConfigDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenHyperparameterConfigDiff fromProto(ai.verta.modeldb.versioning.HyperparameterConfigDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.HyperparameterConfigDiff,AutogenHyperparameterConfigBlob
...
> f = x -> AutogenHyperparameterConfigBlob.fromProto(blob.getC());
        ...
        {
            Function<ai.verta.modeldb.versioning.HyperparameterConfigDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.HyperparameterConfigDiff.Builder toProto() {
        ...
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.HyperparameterConfigDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenHyperparameterConfigBlob
(this.A);
        visitor.preVisitDeepAutogenHyperparameterConfigBlob
(this.B);
        visitor.preVisitDeepAutogenHyperparameterConfigBlob
...
(this.Status);
    ...
    public AutogenHyperparameterConfigDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenHyperparameterConfigBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenHyperparameterConfigBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenHyperparameterConfigBlob
(this.C));

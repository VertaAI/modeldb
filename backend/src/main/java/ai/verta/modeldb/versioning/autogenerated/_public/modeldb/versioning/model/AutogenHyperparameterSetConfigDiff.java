...
public class AutogenHyperparameterSetConfigDiff implements ProtoType {
    private AutogenHyperparameterSetConfigBlob
 A;
    private AutogenHyperparameterSetConfigBlob
 B;
    private AutogenHyperparameterSetConfigBlob
 ...
 Status;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<AutogenHyperparameterSetConfigBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenHyperparameterSetConfigDiff setA(AutogenHyperparameterSetConfigBlob
 value) {
 ...
 getA() {
    ...
    public AutogenHyperparameterSetConfigDiff setB(AutogenHyperparameterSetConfigBlob
 value) {
 ...
 getB() {
    ...
    public AutogenHyperparameterSetConfigDiff setC(AutogenHyperparameterSetConfigBlob
 value) {
 ...
 getC() {
    ...
    public AutogenHyperparameterSetConfigDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenHyperparameterSetConfigDiff fromProto(ai.verta.modeldb.versioning.HyperparameterSetConfigDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.HyperparameterSetConfigDiff,AutogenHyperparameterSetConfigBlob
...
> f = x -> AutogenHyperparameterSetConfigBlob.fromProto(blob.getC());
        ...
        {
            Function<ai.verta.modeldb.versioning.HyperparameterSetConfigDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.HyperparameterSetConfigDiff.Builder toProto() {
        ...
        {
            if (this.A != null && !this.A.equals(null) ) {
                Function<ai.verta.modeldb.versioning.HyperparameterSetConfigDiff.Builder,Void> f = x -> { builder.setA(this.A.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.B != null && !this.B.equals(null) ) {
                Function<ai.verta.modeldb.versioning.HyperparameterSetConfigDiff.Builder,Void> f = x -> { builder.setB(this.B.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.HyperparameterSetConfigDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenHyperparameterSetConfigBlob
(this.A);
        visitor.preVisitDeepAutogenHyperparameterSetConfigBlob
(this.B);
        visitor.preVisitDeepAutogenHyperparameterSetConfigBlob
...
(this.Status);
    ...
    public AutogenHyperparameterSetConfigDiff postVisitShallow(Visitor visitor) throws ModelDBException {
    ...
    public AutogenHyperparameterSetConfigDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenHyperparameterSetConfigBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenHyperparameterSetConfigBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenHyperparameterSetConfigBlob
(this.C));

...
public class AutogenPathDatasetComponentDiff implements ProtoType {
    private AutogenPathDatasetComponentBlob
 A;
    private AutogenPathDatasetComponentBlob
 B;
    private AutogenPathDatasetComponentBlob
 ...
 Status;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<AutogenPathDatasetComponentBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenPathDatasetComponentDiff setA(AutogenPathDatasetComponentBlob
 value) {
 ...
 getA() {
    ...
    public AutogenPathDatasetComponentDiff setB(AutogenPathDatasetComponentBlob
 value) {
 ...
 getB() {
    ...
    public AutogenPathDatasetComponentDiff setC(AutogenPathDatasetComponentBlob
 value) {
 ...
 getC() {
    ...
    public AutogenPathDatasetComponentDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenPathDatasetComponentDiff fromProto(ai.verta.modeldb.versioning.PathDatasetComponentDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.PathDatasetComponentDiff,AutogenPathDatasetComponentBlob
...
> f = x -> AutogenPathDatasetComponentBlob.fromProto(blob.getC());
        ...
        {
            Function<ai.verta.modeldb.versioning.PathDatasetComponentDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.PathDatasetComponentDiff.Builder toProto() {
        ...
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.PathDatasetComponentDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenPathDatasetComponentBlob
(this.A);
        visitor.preVisitDeepAutogenPathDatasetComponentBlob
(this.B);
        visitor.preVisitDeepAutogenPathDatasetComponentBlob
...
(this.Status);
    ...
    public AutogenPathDatasetComponentDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenPathDatasetComponentBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenPathDatasetComponentBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenPathDatasetComponentBlob
(this.C));

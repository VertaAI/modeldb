...
public class AutogenDiscreteHyperparameterSetConfigBlobGen extends Generator<AutogenDiscreteHyperparameterSetConfigBlob> {
    public AutogenDiscreteHyperparameterSetConfigBlobGen() {
        super(AutogenDiscreteHyperparameterSetConfigBlob.class);
    }

    @Override public AutogenDiscreteHyperparameterSetConfigBlob generate(
...
> ret = new ArrayList(size);
                    for (int i = 0; i < size; i++) {
                        ret.add(gen().type(AutogenHyperparameterValuesConfigBlob

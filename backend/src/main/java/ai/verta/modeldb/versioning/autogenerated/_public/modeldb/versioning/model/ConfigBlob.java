...
public class ConfigBlob implements ProtoType {
    ...
    public String toString() {
        return "{\"class\": \"ConfigBlob\",\"fields\": {" +
                "\"HyperparameterSet\": " + HyperparameterSet + ", " +
    ...
    public ConfigBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setHyperparameterSet(visitor.postVisitDeepListOfHyperparameterSetConfigBlob(this.HyperparameterSet));
        this.setHyperparameters(visitor.postVisitDeepListOfHyperparameterConfigBlob(this.Hyperparameters));

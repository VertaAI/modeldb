...
public class AutogenCodeBlobGen extends Generator<AutogenCodeBlob> {
    ...
    @Override public AutogenCodeBlob generate(
            ...
            GenerationStatus status) {
                ...
                if (r.nextBoolean()) {
                    obj.setGit(Utils.removeEmpty(gen().type(AutogenGitCodeBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setNotebook(Utils.removeEmpty(gen().type(AutogenNotebookCodeBlob
.class).generate(r, status)));
                }
                return obj;
    }

...
public class AutogenVersionEnvironmentDiffGen extends Generator<AutogenVersionEnvironmentDiff> {
    ...
    @Override public AutogenVersionEnvironmentDiff generate(
            ...
            GenerationStatus status) {
                ...
                if (r.nextBoolean()) {
                    obj.setA(Utils.removeEmpty(gen().type(AutogenVersionEnvironmentBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setB(Utils.removeEmpty(gen().type(AutogenVersionEnvironmentBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setC(Utils.removeEmpty(gen().type(AutogenVersionEnvironmentBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {

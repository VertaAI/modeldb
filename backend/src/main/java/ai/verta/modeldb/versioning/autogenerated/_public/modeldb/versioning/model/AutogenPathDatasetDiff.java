...
public class AutogenPathDatasetDiff implements ProtoType {
    private List<AutogenPathDatasetComponentDiff
>
 Components;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<List<AutogenPathDatasetComponentDiff
>
,List<AutogenPathDatasetComponentDiff
>
,Boolean> f = (x2, y2) -> IntStream.range(0, Math.min(x2.size(), y2.size())).mapToObj(i -> { Function3<AutogenPathDatasetComponentDiff
...
,Boolean> f2 = (x, y) -> x.equals(y); return f2.apply(x2.get(i), y2.get(i));}).filter(x -> x.equals(false)).collect(Collectors.toList()).isEmpty();
    ...
    public AutogenPathDatasetDiff setComponents(List<AutogenPathDatasetComponentDiff
>
 value) {
        this.Components = Utils.removeEmpty(value);
        if (this.Components != null) {
            this.Components.sort(Comparator.comparingInt(AutogenPathDatasetComponentDiff
::hashCode));
        }
        return this;
    }
    public List<AutogenPathDatasetComponentDiff
>
 getComponents() {
        return this.Components;
    }

    static public AutogenPathDatasetDiff fromProto(ai.verta.modeldb.versioning.PathDatasetDiff blob) {
        if (blob == null) {
            return null;
        }
...
>
> f = x -> blob.getComponentsList().stream().map(AutogenPathDatasetComponentDiff::fromProto).collect(Collectors.toList());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepListOfAutogenPathDatasetComponentDiff
...
(this.Components);
    ...
    public AutogenPathDatasetDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setComponents(visitor.postVisitDeepListOfAutogenPathDatasetComponentDiff

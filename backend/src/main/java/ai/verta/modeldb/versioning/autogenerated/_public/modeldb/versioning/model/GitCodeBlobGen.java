...
public class GitCodeBlobGen extends Generator<GitCodeBlob> {
  public GitCodeBlobGen() {
    super(GitCodeBlob.class);
  }

  @Override
  public GitCodeBlob generate(SourceOfRandomness r, GenerationStatus status) {
    // if (r.nextBoolean())
    //     return null;

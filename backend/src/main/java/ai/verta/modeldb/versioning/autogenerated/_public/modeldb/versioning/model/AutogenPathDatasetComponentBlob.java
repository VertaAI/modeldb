...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenPathDatasetComponentBlob setInternalVersionedPath(String
 value) {
 ...
 getInternalVersionedPath() {
    ...
    public AutogenPathDatasetComponentBlob setLastModifiedAtSource(Long
 value) {
        this.LastModifiedAtSource = Utils.removeEmpty(value);
        return this;
    }
    public Long
 getLastModifiedAtSource() {
        return this.LastModifiedAtSource;
    }
    public AutogenPathDatasetComponentBlob setMd5(String
 value) {
 ...
 getMd5() {
    ...
    public AutogenPathDatasetComponentBlob setPath(String
 value) {
 ...
 getPath() {
    ...
    public AutogenPathDatasetComponentBlob setSha256(String
 value) {
 ...
 getSha256() {
    ...
    public AutogenPathDatasetComponentBlob setSize(Long
 value) {
 ...
 getSize() {
    ...
    static public AutogenPathDatasetComponentBlob fromProto(ai.verta.modeldb.versioning.PathDatasetComponentBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.PathDatasetComponentBlob,String
> f = x -> (blob.getInternalVersionedPath());
            obj.setInternalVersionedPath(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.PathDatasetComponentBlob,Long
> f = x -> (blob.getLastModifiedAtSource());
...
> f = x -> (blob.getSize());
    ...
    public ai.verta.modeldb.versioning.PathDatasetComponentBlob.Builder toProto() {
        ...
        {
            if (this.InternalVersionedPath != null && !this.InternalVersionedPath.equals("") ) {
                Function<ai.verta.modeldb.versioning.PathDatasetComponentBlob.Builder,Void> f = x -> { builder.setInternalVersionedPath(this.InternalVersionedPath); return null; };
                f.apply(builder);
            }
        }
        {
...
(this.Size);
    ...
    public AutogenPathDatasetComponentBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setInternalVersionedPath(visitor.postVisitDeepString
(this.InternalVersionedPath));
        this.setLastModifiedAtSource(visitor.postVisitDeepLong
(this.LastModifiedAtSource));
        this.setMd5(visitor.postVisitDeepString
(this.Md5));
        this.setPath(visitor.postVisitDeepString
(this.Path));
        this.setSha256(visitor.postVisitDeepString
(this.Sha256));
        this.setSize(visitor.postVisitDeepLong
(this.Size));

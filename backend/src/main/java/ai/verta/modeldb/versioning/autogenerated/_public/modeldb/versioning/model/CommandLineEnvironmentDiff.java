...
public class CommandLineEnvironmentDiff implements ProtoType {
    ...
    static public CommandLineEnvironmentDiff fromProto(ai.verta.modeldb.versioning.CommandLineEnvironmentDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff,DiffStatusEnumDiffStatus> f = x -> DiffStatusEnumDiffStatus.fromProto(blob.getStatus());
            obj.Status = Utils.removeEmpty(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff,List<String>> f = x -> blob.getAList();
            obj.A = Utils.removeEmpty(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff,List<String>> f = x -> blob.getBList();

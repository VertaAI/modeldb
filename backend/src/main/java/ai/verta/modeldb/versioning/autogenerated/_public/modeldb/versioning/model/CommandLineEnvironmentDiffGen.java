...
public class CommandLineEnvironmentDiffGen extends Generator<CommandLineEnvironmentDiff> {
  public CommandLineEnvironmentDiffGen() {
    super(CommandLineEnvironmentDiff.class);
  }

  @Override
  public CommandLineEnvironmentDiff generate(SourceOfRandomness r, GenerationStatus status) {
    // if (r.nextBoolean())
    //     return null;

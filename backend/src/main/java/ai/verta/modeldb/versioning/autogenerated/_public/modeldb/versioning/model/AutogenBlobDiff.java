...
public class AutogenBlobDiff implements ProtoType {
    private AutogenCodeDiff
 Code;
    private AutogenConfigDiff
 Config;
    private AutogenDatasetDiff
 Dataset;
    private AutogenEnvironmentDiff
 Environment;
    private List<String
>
 Location;
...
,Boolean> f = (x, y) -> x.equals(y);
        ...
        {
            Function3<AutogenEnvironmentDiff
,AutogenEnvironmentDiff
,Boolean> f = (x, y) -> x.equals(y);
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenBlobDiff setCode(AutogenCodeDiff
 value) {
 ...
 getCode() {
    ...
    public AutogenBlobDiff setConfig(AutogenConfigDiff
 value) {
 ...
 getConfig() {
    ...
    public AutogenBlobDiff setDataset(AutogenDatasetDiff
 value) {
 ...
 getDataset() {
    ...
    public AutogenBlobDiff setEnvironment(AutogenEnvironmentDiff
 value) {
 ...
 getEnvironment() {
    ...
    public AutogenBlobDiff setLocation(List<String
>
 value) {
...
>
 getLocation() {
    ...
    public AutogenBlobDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenBlobDiff fromProto(ai.verta.modeldb.versioning.BlobDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.BlobDiff,AutogenCodeDiff
> f = x -> AutogenCodeDiff.fromProto(blob.getCode());
            obj.setCode(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.BlobDiff,AutogenConfigDiff
> f = x -> AutogenConfigDiff.fromProto(blob.getConfig());
            obj.setConfig(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.BlobDiff,AutogenDatasetDiff
> f = x -> AutogenDatasetDiff.fromProto(blob.getDataset());
            obj.setDataset(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.BlobDiff,AutogenEnvironmentDiff
> f = x -> AutogenEnvironmentDiff.fromProto(blob.getEnvironment());
            obj.setEnvironment(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.BlobDiff,List<String
>
> f = x -> blob.getLocationList();
            obj.setLocation(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.BlobDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenCodeDiff
(this.Code);
        visitor.preVisitDeepAutogenConfigDiff
(this.Config);
        visitor.preVisitDeepAutogenDatasetDiff
(this.Dataset);
        visitor.preVisitDeepAutogenEnvironmentDiff
(this.Environment);
...
(this.Status);
    ...
    public AutogenBlobDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setCode(visitor.postVisitDeepAutogenCodeDiff
(this.Code));
        this.setConfig(visitor.postVisitDeepAutogenConfigDiff
(this.Config));
        this.setDataset(visitor.postVisitDeepAutogenDatasetDiff
(this.Dataset));
        this.setEnvironment(visitor.postVisitDeepAutogenEnvironmentDiff
(this.Environment));
        this.setLocation(visitor.postVisitDeepListOfString

...
public class AutogenHyperparameterSetConfigBlob implements ProtoType {
    private AutogenContinuousHyperparameterSetConfigBlob
 Continuous;
    private AutogenDiscreteHyperparameterSetConfigBlob
 Discrete;
    private String
 Name;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<AutogenContinuousHyperparameterSetConfigBlob
...
,Boolean> f = (x, y) -> x.equals(y);
        ...
        {
            Function3<AutogenDiscreteHyperparameterSetConfigBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenHyperparameterSetConfigBlob setContinuous(AutogenContinuousHyperparameterSetConfigBlob
 value) {
 ...
 getContinuous() {
    ...
    public AutogenHyperparameterSetConfigBlob setDiscrete(AutogenDiscreteHyperparameterSetConfigBlob
 value) {
 ...
 getDiscrete() {
    ...
    public AutogenHyperparameterSetConfigBlob setName(String
 value) {
 ...
 getName() {
    ...
    static public AutogenHyperparameterSetConfigBlob fromProto(ai.verta.modeldb.versioning.HyperparameterSetConfigBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.HyperparameterSetConfigBlob,AutogenContinuousHyperparameterSetConfigBlob
> f = x -> AutogenContinuousHyperparameterSetConfigBlob.fromProto(blob.getContinuous());
            obj.setContinuous(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.HyperparameterSetConfigBlob,AutogenDiscreteHyperparameterSetConfigBlob
> f = x -> AutogenDiscreteHyperparameterSetConfigBlob.fromProto(blob.getDiscrete());
            obj.setDiscrete(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.HyperparameterSetConfigBlob,String
> f = x -> (blob.getName());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenContinuousHyperparameterSetConfigBlob
(this.Continuous);
        visitor.preVisitDeepAutogenDiscreteHyperparameterSetConfigBlob
(this.Discrete);
        visitor.preVisitDeepString
(this.Name);
    }

    public AutogenHyperparameterSetConfigBlob postVisitShallow(Visitor visitor) throws ModelDBException {
    ...
    public AutogenHyperparameterSetConfigBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setContinuous(visitor.postVisitDeepAutogenContinuousHyperparameterSetConfigBlob
(this.Continuous));
        this.setDiscrete(visitor.postVisitDeepAutogenDiscreteHyperparameterSetConfigBlob
(this.Discrete));
        this.setName(visitor.postVisitDeepString
(this.Name));

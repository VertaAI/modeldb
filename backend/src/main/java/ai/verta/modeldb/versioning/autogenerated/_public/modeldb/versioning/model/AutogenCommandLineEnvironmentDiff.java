...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenCommandLineEnvironmentDiff setA(List<String
>
 value) {
...
>
 getA() {
    ...
    public AutogenCommandLineEnvironmentDiff setB(List<String
>
 value) {
...
>
 getB() {
    ...
    public AutogenCommandLineEnvironmentDiff setC(List<String
>
 value) {
...
>
 getC() {
    ...
    public AutogenCommandLineEnvironmentDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenCommandLineEnvironmentDiff fromProto(ai.verta.modeldb.versioning.CommandLineEnvironmentDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff,List<String
>
> f = x -> blob.getAList();
...
> f = x -> blob.getCList();
        ...
        {
            Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.Builder toProto() {
        ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.Builder builder = ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.newBuilder();
        {
            if (this.A != null && !this.A.equals(null)  && !this.A.isEmpty()) {
                Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.Builder,Void> f = x -> { builder.addAllA(this.A); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.B != null && !this.B.equals(null)  && !this.B.isEmpty()) {
                Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.Builder,Void> f = x -> { builder.addAllB(this.B); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.C != null && !this.C.equals(null)  && !this.C.isEmpty()) {
                Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.Builder,Void> f = x -> { builder.addAllC(this.C); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.Status != null && !this.Status.equals(null) ) {
                Function<ai.verta.modeldb.versioning.CommandLineEnvironmentDiff.Builder,Void> f = x -> { builder.setStatus(this.Status.toProto()); return null; };
                f.apply(builder);
            }
        }
        return builder;
...
(this.Status);
    ...
    public AutogenCommandLineEnvironmentDiff postVisitShallow(Visitor visitor) throws ModelDBException {
    ...
    public AutogenCommandLineEnvironmentDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepListOfString

(this.A));
        this.setB(visitor.postVisitDeepListOfString

(this.B));
        this.setC(visitor.postVisitDeepListOfString

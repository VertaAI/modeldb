...
public class ConflictGenerator {
  ...
  public static List<BlobDiff> setConflictBlobsInDiff(
    ...
    if(locSpecificBlobDiffA.get(0).getContentCase() == locSpecificBlobDiffB.get(0).getContentCase()) {
    ...
    return Collections.singletonList(diff.toProto().build());}
    else {
        ...
        .setConfig(getConfigConflictBlob(a.getConfig(), b.getConfig(), c.getConfig()));
			break;
		case DATASET:    diff1.setDataset(getDatasetConflictBlob(a.getDataset(), b.getDataset(), c.getDataset()));
			break;
		case ENVIRONMENT:    diff1
        .setEnvironment(
            getEnvironmentonflictBlob(a.getEnvironment(), b.getEnvironment(), c.getEnvironment()));
			break;
        ...
        .setConfig(getConfigConflictBlob(a.getConfig(), b.getConfig(), c.getConfig()));
			break;
		case DATASET:    diff2.setDataset(getDatasetConflictBlob(a.getDataset(), b.getDataset(), c.getDataset()));
			break;
		case ENVIRONMENT:    diff2
        .setEnvironment(
            getEnvironmentonflictBlob(a.getEnvironment(), b.getEnvironment(), c.getEnvironment()));
			break;
		case CONTENT_NOT_SET:

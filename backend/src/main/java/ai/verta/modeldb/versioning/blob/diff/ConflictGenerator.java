...
public class ConflictGenerator {
  ...
  public static BlobDiff setConflictBlobsInDiff(
    ...
    diff.setDataset(getDatasetConflictBlob(a.getDataset(), b.getDataset(), c.getDataset()))
        ...
        .setDescription(
            getDescriptionDiff(a.getDescription(), b.getDescription(), c.getDescription()));

    return diff.toProto().build();
  }

  private static AutogenDescriptionDiff getDescriptionDiff(
      AutogenDescriptionDiff a, AutogenDescriptionDiff b, String c) {
    if ((a == null && b == null) || (a != null && a.equals(b))) return null;
    AutogenDescriptionDiff ret = new AutogenDescriptionDiff();

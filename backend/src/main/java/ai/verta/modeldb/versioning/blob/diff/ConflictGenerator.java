...
import ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.AutogenS3VersionIdDiff;
              ...
              new AutogenS3DatasetComponentDiff()
                  .setPath(
                      new AutogenPathDatasetComponentDiff()
                          ...
                          .setA(mapA.get(key).getPath())
                          .setB(mapB.get(key).getPath())
                          .setC(mapC.get(key).getPath()))
                  .setS3VersionId(
                      new AutogenS3VersionIdDiff()
                          .setStatus(
                              AutogenDiffStatusEnumDiffStatus.fromProto(DiffStatus.CONFLICTED))
    ...
    for (AutogenS3DatasetComponentDiff diff : list) {
      ...
      retMap.put(
          ...
          new AutogenS3DatasetComponentBlob()
              .setPath(diff.getPath().getB())
              .setS3VersionId(diff.getS3VersionId().getB()));
    }
    return retMap;
  }

...
public class VersionEnvironmentDiff implements ProtoType {
    ...
    public String toString() {
        return "{\"class\": \"VersionEnvironmentDiff\",\"fields\": {" +
                "\"Status\": " + Status + ", " +
                "\"A\": " + A + ", " +
                "\"B\": " + B + 
                "}}";
    ...
    static public VersionEnvironmentDiff fromProto(ai.verta.modeldb.versioning.VersionEnvironmentDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.VersionEnvironmentDiff,DiffStatusEnumDiffStatus> f = x -> DiffStatusEnumDiffStatus.fromProto(blob.getStatus());
            obj.Status = Utils.removeEmpty(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.VersionEnvironmentDiff,VersionEnvironmentBlob> f = x -> VersionEnvironmentBlob.fromProto(blob.getA());
            obj.A = Utils.removeEmpty(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.VersionEnvironmentDiff,VersionEnvironmentBlob> f = x -> VersionEnvironmentBlob.fromProto(blob.getB());

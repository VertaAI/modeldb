...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenGitCodeBlob setBranch(String
 value) {
 ...
 getBranch() {
    ...
    public AutogenGitCodeBlob setHash(String
 value) {
 ...
 getHash() {
    ...
    public AutogenGitCodeBlob setIsDirty(Boolean
 value) {
 ...
 getIsDirty() {
    ...
    public AutogenGitCodeBlob setRepo(String
 value) {
 ...
 getRepo() {
    ...
    public AutogenGitCodeBlob setTag(String
 value) {
 ...
 getTag() {
    ...
    static public AutogenGitCodeBlob fromProto(ai.verta.modeldb.versioning.GitCodeBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.GitCodeBlob,String
> f = x -> (blob.getBranch());
...
> f = x -> (blob.getHash());
        ...
        {
            Function<ai.verta.modeldb.versioning.GitCodeBlob,Boolean
> f = x -> (blob.getIsDirty());
...
(this.Tag);
    ...
    public AutogenGitCodeBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setBranch(visitor.postVisitDeepString
(this.Branch));
        this.setHash(visitor.postVisitDeepString
(this.Hash));
        this.setIsDirty(visitor.postVisitDeepBoolean
(this.IsDirty));
        this.setRepo(visitor.postVisitDeepString
(this.Repo));
        this.setTag(visitor.postVisitDeepString
(this.Tag));

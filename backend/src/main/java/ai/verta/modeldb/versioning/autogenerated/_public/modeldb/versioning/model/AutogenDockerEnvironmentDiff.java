...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenDockerEnvironmentDiff setA(AutogenDockerEnvironmentBlob
 value) {
 ...
 getA() {
    ...
    public AutogenDockerEnvironmentDiff setB(AutogenDockerEnvironmentBlob
 value) {
 ...
 getB() {
    ...
    public AutogenDockerEnvironmentDiff setC(AutogenDockerEnvironmentBlob
 value) {
 ...
 getC() {
    ...
    public AutogenDockerEnvironmentDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenDockerEnvironmentDiff fromProto(ai.verta.modeldb.versioning.DockerEnvironmentDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.DockerEnvironmentDiff,AutogenDockerEnvironmentBlob
> f = x -> AutogenDockerEnvironmentBlob.fromProto(blob.getA());
            obj.setA(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.DockerEnvironmentDiff,AutogenDockerEnvironmentBlob
> f = x -> AutogenDockerEnvironmentBlob.fromProto(blob.getB());
            obj.setB(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.DockerEnvironmentDiff,AutogenDockerEnvironmentBlob
> f = x -> AutogenDockerEnvironmentBlob.fromProto(blob.getC());
...
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.DockerEnvironmentDiff.Builder toProto() {
        ...
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.DockerEnvironmentDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.Status != null && !this.Status.equals(null) ) {
                Function<ai.verta.modeldb.versioning.DockerEnvironmentDiff.Builder,Void> f = x -> { builder.setStatus(this.Status.toProto()); return null; };
                f.apply(builder);
            }
        }
        return builder;
...
(this.Status);
    ...
    public AutogenDockerEnvironmentDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenDockerEnvironmentBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenDockerEnvironmentBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenDockerEnvironmentBlob
(this.C));

...
public class AutogenContinuousHyperparameterSetConfigBlob implements ProtoType {
    private AutogenHyperparameterValuesConfigBlob
 IntervalBegin;
    private AutogenHyperparameterValuesConfigBlob
 IntervalEnd;
    private AutogenHyperparameterValuesConfigBlob
 IntervalStep;
    ...
    public boolean equals(Object o) {
        ...
        AutogenContinuousHyperparameterSetConfigBlob other = (AutogenContinuousHyperparameterSetConfigBlob) o;

        {
            Function3<AutogenHyperparameterValuesConfigBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenContinuousHyperparameterSetConfigBlob setIntervalBegin(AutogenHyperparameterValuesConfigBlob
 value) {
 ...
 getIntervalBegin() {
    ...
    public AutogenContinuousHyperparameterSetConfigBlob setIntervalEnd(AutogenHyperparameterValuesConfigBlob
 value) {
 ...
 getIntervalEnd() {
    ...
    public AutogenContinuousHyperparameterSetConfigBlob setIntervalStep(AutogenHyperparameterValuesConfigBlob
 value) {
 ...
 getIntervalStep() {
    ...
    static public AutogenContinuousHyperparameterSetConfigBlob fromProto(ai.verta.modeldb.versioning.ContinuousHyperparameterSetConfigBlob blob) {
        if (blob == null) {
            return null;
        }

        AutogenContinuousHyperparameterSetConfigBlob obj = new AutogenContinuousHyperparameterSetConfigBlob();
        {
            Function<ai.verta.modeldb.versioning.ContinuousHyperparameterSetConfigBlob,AutogenHyperparameterValuesConfigBlob
...
> f = x -> AutogenHyperparameterValuesConfigBlob.fromProto(blob.getIntervalStep());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenHyperparameterValuesConfigBlob
(this.IntervalBegin);
        visitor.preVisitDeepAutogenHyperparameterValuesConfigBlob
(this.IntervalEnd);
        visitor.preVisitDeepAutogenHyperparameterValuesConfigBlob
(this.IntervalStep);
    ...
    public AutogenContinuousHyperparameterSetConfigBlob postVisitShallow(Visitor visitor) throws ModelDBException {
        return visitor.postVisitAutogenContinuousHyperparameterSetConfigBlob(this);
    }

    public AutogenContinuousHyperparameterSetConfigBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setIntervalBegin(visitor.postVisitDeepAutogenHyperparameterValuesConfigBlob
(this.IntervalBegin));
        this.setIntervalEnd(visitor.postVisitDeepAutogenHyperparameterValuesConfigBlob
(this.IntervalEnd));
        this.setIntervalStep(visitor.postVisitDeepAutogenHyperparameterValuesConfigBlob
(this.IntervalStep));

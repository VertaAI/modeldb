...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenHyperparameterConfigBlob setName(String
 value) {
 ...
 getName() {
    ...
    public AutogenHyperparameterConfigBlob setValue(AutogenHyperparameterValuesConfigBlob
 value) {
 ...
 getValue() {
    ...
    static public AutogenHyperparameterConfigBlob fromProto(ai.verta.modeldb.versioning.HyperparameterConfigBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.HyperparameterConfigBlob,String
> f = x -> (blob.getName());
            obj.setName(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.HyperparameterConfigBlob,AutogenHyperparameterValuesConfigBlob
...
(this.Name));
        this.setValue(visitor.postVisitDeepAutogenHyperparameterValuesConfigBlob
(this.Value));

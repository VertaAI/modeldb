...
>
 CommandLine;
    private AutogenDockerEnvironmentBlob
 Docker;
    private List<AutogenEnvironmentVariablesBlob
>
 EnvironmentVariables;
    private AutogenPythonEnvironmentBlob
 Python;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<List<String
>
,List<String
>
,Boolean> f = (x2, y2) -> IntStream.range(0, Math.min(x2.size(), y2.size())).mapToObj(i -> { Function3<String
,String
,Boolean> f2 = (x, y) -> x.equals(y); return f2.apply(x2.get(i), y2.get(i));}).filter(x -> x.equals(false)).collect(Collectors.toList()).isEmpty();
        ...
        {
            Function3<AutogenDockerEnvironmentBlob
,AutogenDockerEnvironmentBlob
,Boolean> f = (x, y) -> x.equals(y);
        ...
        {
            Function3<List<AutogenEnvironmentVariablesBlob
>
,List<AutogenEnvironmentVariablesBlob
>
,Boolean> f = (x2, y2) -> IntStream.range(0, Math.min(x2.size(), y2.size())).mapToObj(i -> { Function3<AutogenEnvironmentVariablesBlob
...
,Boolean> f2 = (x, y) -> x.equals(y); return f2.apply(x2.get(i), y2.get(i));}).filter(x -> x.equals(false)).collect(Collectors.toList()).isEmpty();
        ...
        {
            Function3<AutogenPythonEnvironmentBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenEnvironmentBlob setCommandLine(List<String
>
 value) {
...
>
 getCommandLine() {
    ...
    public AutogenEnvironmentBlob setDocker(AutogenDockerEnvironmentBlob
 value) {
 ...
 getDocker() {
    ...
    public AutogenEnvironmentBlob setEnvironmentVariables(List<AutogenEnvironmentVariablesBlob
>
 value) {
        this.EnvironmentVariables = Utils.removeEmpty(value);
        if (this.EnvironmentVariables != null) {
            this.EnvironmentVariables.sort(Comparator.comparingInt(AutogenEnvironmentVariablesBlob
::hashCode));
        }
        return this;
    }
    public List<AutogenEnvironmentVariablesBlob
>
 getEnvironmentVariables() {
        return this.EnvironmentVariables;
    }
    public AutogenEnvironmentBlob setPython(AutogenPythonEnvironmentBlob
 value) {
 ...
 getPython() {
    ...
    static public AutogenEnvironmentBlob fromProto(ai.verta.modeldb.versioning.EnvironmentBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.EnvironmentBlob,List<String
>
> f = x -> blob.getCommandLineList();
            obj.setCommandLine(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.EnvironmentBlob,AutogenDockerEnvironmentBlob
> f = x -> AutogenDockerEnvironmentBlob.fromProto(blob.getDocker());
            obj.setDocker(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.EnvironmentBlob,List<AutogenEnvironmentVariablesBlob
>
> f = x -> blob.getEnvironmentVariablesList().stream().map(AutogenEnvironmentVariablesBlob::fromProto).collect(Collectors.toList());
            obj.setEnvironmentVariables(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.EnvironmentBlob,AutogenPythonEnvironmentBlob
> f = x -> AutogenPythonEnvironmentBlob.fromProto(blob.getPython());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepListOfString

(this.CommandLine);
        visitor.preVisitDeepAutogenDockerEnvironmentBlob
(this.Docker);
        visitor.preVisitDeepListOfAutogenEnvironmentVariablesBlob

(this.EnvironmentVariables);
        visitor.preVisitDeepAutogenPythonEnvironmentBlob
(this.Python);
    }
    ...
    public AutogenEnvironmentBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setCommandLine(visitor.postVisitDeepListOfString

(this.CommandLine));
        this.setDocker(visitor.postVisitDeepAutogenDockerEnvironmentBlob
(this.Docker));
        this.setEnvironmentVariables(visitor.postVisitDeepListOfAutogenEnvironmentVariablesBlob

(this.EnvironmentVariables));
        this.setPython(visitor.postVisitDeepAutogenPythonEnvironmentBlob
(this.Python));

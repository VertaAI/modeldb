...
public class DiffMerger {
  ...
  public static AutogenGitCodeBlob mergeGitCode(
    ...
    return Utils.removeEmpty(mergeLast(a, d, x -> d.getB(), AutogenGitCodeDiff::getStatus,AutogenGitCodeBlob::getRepo, conflictKeys));
  }
  ...
  public static AutogenDockerEnvironmentBlob mergeDockerEnvironment(
    ...
    return Utils.removeEmpty(
        mergeLast(
            a, d, AutogenDockerEnvironmentDiff::getB, AutogenDockerEnvironmentDiff::getStatus,AutogenDockerEnvironmentBlob::getRepository,conflictKeys));
  }

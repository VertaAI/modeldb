...
public class AutogenS3DatasetComponentDiff implements ProtoType {
    private AutogenS3DatasetComponentBlob
 A;
    private AutogenS3DatasetComponentBlob
 B;
    private AutogenS3DatasetComponentBlob
 ...
 Status;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<AutogenS3DatasetComponentBlob
...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenS3DatasetComponentDiff setA(AutogenS3DatasetComponentBlob
 value) {
 ...
 getA() {
    ...
    public AutogenS3DatasetComponentDiff setB(AutogenS3DatasetComponentBlob
 value) {
 ...
 getB() {
    ...
    public AutogenS3DatasetComponentDiff setC(AutogenS3DatasetComponentBlob
 value) {
 ...
 getC() {
    ...
    public AutogenS3DatasetComponentDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenS3DatasetComponentDiff fromProto(ai.verta.modeldb.versioning.S3DatasetComponentDiff blob) {
        if (blob == null) {
            return null;
        }
...
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.S3DatasetComponentDiff.Builder toProto() {
        ...
        {
            if (this.A != null && !this.A.equals(null) ) {
                Function<ai.verta.modeldb.versioning.S3DatasetComponentDiff.Builder,Void> f = x -> { builder.setA(this.A.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.B != null && !this.B.equals(null) ) {
                Function<ai.verta.modeldb.versioning.S3DatasetComponentDiff.Builder,Void> f = x -> { builder.setB(this.B.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.S3DatasetComponentDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
            if (this.Status != null && !this.Status.equals(null) ) {
                Function<ai.verta.modeldb.versioning.S3DatasetComponentDiff.Builder,Void> f = x -> { builder.setStatus(this.Status.toProto()); return null; };
                f.apply(builder);
            }
        }
        return builder;
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenS3DatasetComponentBlob
(this.A);
        visitor.preVisitDeepAutogenS3DatasetComponentBlob
(this.B);
        visitor.preVisitDeepAutogenS3DatasetComponentBlob
...
(this.Status);
    ...
    public AutogenS3DatasetComponentDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenS3DatasetComponentBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenS3DatasetComponentBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenS3DatasetComponentBlob
(this.C));

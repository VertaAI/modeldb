...
public class AutogenHyperparameterConfigDiffGen extends Generator<AutogenHyperparameterConfigDiff> {
    ...
    @Override public AutogenHyperparameterConfigDiff generate(
            ...
            GenerationStatus status) {
                ...
                if (r.nextBoolean()) {
                    obj.setA(Utils.removeEmpty(gen().type(AutogenHyperparameterConfigBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setB(Utils.removeEmpty(gen().type(AutogenHyperparameterConfigBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setC(Utils.removeEmpty(gen().type(AutogenHyperparameterConfigBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {

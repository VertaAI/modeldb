...
public class AutogenCommandLineEnvironmentDiffGen extends Generator<AutogenCommandLineEnvironmentDiff> {
    public AutogenCommandLineEnvironmentDiffGen() {
        super(AutogenCommandLineEnvironmentDiff.class);
    }

    @Override public AutogenCommandLineEnvironmentDiff generate(

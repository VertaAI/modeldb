...
public class EnvironmentContainer extends BlobContainer {
  ...
  private String computeSHA(EnvironmentBlob blob) throws NoSuchAlgorithmException {
    ...
    sb.append("env:");
    List<ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.EnvironmentVariablesBlob> environmentVariables = ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.EnvironmentBlob
        .fromProto(blob)
        .EnvironmentVariables;
    sb.append(environmentVariables == null ? "null" : new HashSet<>(
        environmentVariables).hashCode());
  ...
  private String computeSHA(PythonEnvironmentBlob blob) throws NoSuchAlgorithmException {
    ...
    ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.PythonEnvironmentBlob blobNew =
        ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.PythonEnvironmentBlob
        .fromProto(blob);
    sb.append(":requirements:");
    sb.append(blobNew.Requirements == null ? "null" : new HashSet<>(blobNew.Requirements).hashCode());
    sb.append(":constraints:");
    sb.append(blobNew.Constraints == null ? "null" : new HashSet<>(blobNew.Constraints).hashCode());
    return FileHasher.getSha(sb.toString());
  }

...
public class EnvironmentContainer extends BlobContainer {
  ...
  private String computeSHA(EnvironmentBlob blob) throws NoSuchAlgorithmException {
    ...
    List<
            ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model
                .EnvironmentVariablesBlob>
        environmentVariables =
            ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model
                .EnvironmentBlob.fromProto(blob)
                .getEnvironmentVariables();
    if (environmentVariables != null) {
      sb.append("env:");
      sb.append(new HashSet<>(environmentVariables).hashCode());
    }
  ...
  private String computeSHA(PythonEnvironmentBlob blob) throws NoSuchAlgorithmException {
    ...
    ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.PythonEnvironmentBlob
        blobNew =
            ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model
                .PythonEnvironmentBlob.fromProto(blob);
    List<ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.PythonRequirementEnvironmentBlob> requirements = blobNew
        .getRequirements();
    if (requirements != null) {
      sb.append(":requirements:");
      sb.append(new HashSet<>(requirements).hashCode());
    }
    List<ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.PythonRequirementEnvironmentBlob> constraints = blobNew
        .getConstraints();
    if (constraints != null) {
      sb.append(":constraints:");
      sb.append(new HashSet<>(constraints).hashCode());
    }
    return FileHasher.getSha(sb.toString());
  }

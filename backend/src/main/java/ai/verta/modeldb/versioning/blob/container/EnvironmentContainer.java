...
public class EnvironmentContainer extends BlobContainer {
  ...
  private String computeSHA(EnvironmentBlob blob) throws NoSuchAlgorithmException {
    ...
    sb.append(new HashSet<>(
        ai.verta.modeldb.versioning.autogenerated._public.modeldb.versioning.model.EnvironmentBlob.fromProto(blob)
  ...
  private String computeSHA(PythonEnvironmentBlob blob) throws NoSuchAlgorithmException {
    ...
    sb.append(new HashSet<>(blobNew.Requirements).hashCode());
    sb.append(":constraints:");
    sb.append(new HashSet<>(blobNew.Constraints).hashCode());
    return FileHasher.getSha(sb.toString());
  }

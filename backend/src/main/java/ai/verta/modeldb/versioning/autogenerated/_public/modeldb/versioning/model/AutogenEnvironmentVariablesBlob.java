...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenEnvironmentVariablesBlob setName(String
 value) {
 ...
 getName() {
    ...
    public AutogenEnvironmentVariablesBlob setValue(String
 value) {
 ...
 getValue() {
    ...
    static public AutogenEnvironmentVariablesBlob fromProto(ai.verta.modeldb.versioning.EnvironmentVariablesBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.EnvironmentVariablesBlob,String
> f = x -> (blob.getName());
...
(this.Name));
        this.setValue(visitor.postVisitDeepString
(this.Value));

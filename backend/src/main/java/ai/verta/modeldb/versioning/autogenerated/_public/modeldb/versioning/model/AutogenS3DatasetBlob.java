...
public class AutogenS3DatasetBlob implements ProtoType {
    private List<AutogenS3DatasetComponentBlob
>
 Components;
    ...
    public boolean equals(Object o) {
        ...
        {
            Function3<List<AutogenS3DatasetComponentBlob
>
,List<AutogenS3DatasetComponentBlob
>
,Boolean> f = (x2, y2) -> IntStream.range(0, Math.min(x2.size(), y2.size())).mapToObj(i -> { Function3<AutogenS3DatasetComponentBlob
...
,Boolean> f2 = (x, y) -> x.equals(y); return f2.apply(x2.get(i), y2.get(i));}).filter(x -> x.equals(false)).collect(Collectors.toList()).isEmpty();
    ...
    public AutogenS3DatasetBlob setComponents(List<AutogenS3DatasetComponentBlob
>
 value) {
        this.Components = Utils.removeEmpty(value);
        if (this.Components != null) {
            this.Components.sort(Comparator.comparingInt(AutogenS3DatasetComponentBlob
::hashCode));
        }
        return this;
    }
    public List<AutogenS3DatasetComponentBlob
>
 getComponents() {
        return this.Components;
    }

    static public AutogenS3DatasetBlob fromProto(ai.verta.modeldb.versioning.S3DatasetBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.S3DatasetBlob,List<AutogenS3DatasetComponentBlob
>
> f = x -> blob.getComponentsList().stream().map(AutogenS3DatasetComponentBlob::fromProto).collect(Collectors.toList());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepListOfAutogenS3DatasetComponentBlob
...
(this.Components);
    ...
    public AutogenS3DatasetBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setComponents(visitor.postVisitDeepListOfAutogenS3DatasetComponentBlob

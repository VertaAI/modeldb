...
public class AutogenDatasetBlobGen extends Generator<AutogenDatasetBlob> {
    ...
    @Override public AutogenDatasetBlob generate(
            ...
            GenerationStatus status) {
                ...
                if (r.nextBoolean()) {
                    obj.setPath(Utils.removeEmpty(gen().type(AutogenPathDatasetBlob
.class).generate(r, status)));
                }
                if (r.nextBoolean()) {
                    obj.setS3(Utils.removeEmpty(gen().type(AutogenS3DatasetBlob
.class).generate(r, status)));
                }
                return obj;
    }

...
public class Visitor {
    ...
    public <T> T genericPostVisitDeep(T b) throws ModelDBException {
        if (b instanceof Blob) {
            return (T) postVisitDeepBlob((Blob) b);
        }
        if (b instanceof BlobDiff) {
            return (T) postVisitDeepBlobDiff((BlobDiff) b);
        }
        if (b instanceof CodeBlob) {
            return (T) postVisitDeepCodeBlob((CodeBlob) b);
        }
        if (b instanceof CodeDiff) {
            return (T) postVisitDeepCodeDiff((CodeDiff) b);
        }
        if (b instanceof CommandLineEnvironmentDiff) {
            return (T) postVisitDeepCommandLineEnvironmentDiff((CommandLineEnvironmentDiff) b);
        }
        if (b instanceof ConfigBlob) {
            return (T) postVisitDeepConfigBlob((ConfigBlob) b);
        }
        if (b instanceof ConfigDiff) {
            return (T) postVisitDeepConfigDiff((ConfigDiff) b);
        }
        if (b instanceof ContinuousHyperparameterSetConfigBlob) {
            return (T) postVisitDeepContinuousHyperparameterSetConfigBlob((ContinuousHyperparameterSetConfigBlob) b);
        }
        if (b instanceof DatasetBlob) {
            return (T) postVisitDeepDatasetBlob((DatasetBlob) b);
        }
        if (b instanceof DatasetDiff) {
            return (T) postVisitDeepDatasetDiff((DatasetDiff) b);
        }
        if (b instanceof DiscreteHyperparameterSetConfigBlob) {
            return (T) postVisitDeepDiscreteHyperparameterSetConfigBlob((DiscreteHyperparameterSetConfigBlob) b);
        }
        if (b instanceof DockerEnvironmentBlob) {
            return (T) postVisitDeepDockerEnvironmentBlob((DockerEnvironmentBlob) b);
        }
        if (b instanceof DockerEnvironmentDiff) {
            return (T) postVisitDeepDockerEnvironmentDiff((DockerEnvironmentDiff) b);
        }
        if (b instanceof EnvironmentBlob) {
            return (T) postVisitDeepEnvironmentBlob((EnvironmentBlob) b);
        }
        if (b instanceof EnvironmentDiff) {
            return (T) postVisitDeepEnvironmentDiff((EnvironmentDiff) b);
        }
        if (b instanceof EnvironmentVariablesBlob) {
            return (T) postVisitDeepEnvironmentVariablesBlob((EnvironmentVariablesBlob) b);
        }
        if (b instanceof EnvironmentVariablesDiff) {
            return (T) postVisitDeepEnvironmentVariablesDiff((EnvironmentVariablesDiff) b);
        }
        if (b instanceof GitCodeBlob) {
            return (T) postVisitDeepGitCodeBlob((GitCodeBlob) b);
        }
        if (b instanceof GitCodeDiff) {
            return (T) postVisitDeepGitCodeDiff((GitCodeDiff) b);
        }
        if (b instanceof HyperparameterConfigBlob) {
            return (T) postVisitDeepHyperparameterConfigBlob((HyperparameterConfigBlob) b);
        }
        if (b instanceof HyperparameterConfigDiff) {
            return (T) postVisitDeepHyperparameterConfigDiff((HyperparameterConfigDiff) b);
        }
        if (b instanceof HyperparameterSetConfigBlob) {
            return (T) postVisitDeepHyperparameterSetConfigBlob((HyperparameterSetConfigBlob) b);
        }
        if (b instanceof HyperparameterSetConfigDiff) {
            return (T) postVisitDeepHyperparameterSetConfigDiff((HyperparameterSetConfigDiff) b);
        }
        if (b instanceof HyperparameterValuesConfigBlob) {
            return (T) postVisitDeepHyperparameterValuesConfigBlob((HyperparameterValuesConfigBlob) b);
        }
        if (b instanceof NotebookCodeBlob) {
            return (T) postVisitDeepNotebookCodeBlob((NotebookCodeBlob) b);
        }
        if (b instanceof NotebookCodeDiff) {
            return (T) postVisitDeepNotebookCodeDiff((NotebookCodeDiff) b);
        }
        if (b instanceof PathDatasetBlob) {
            return (T) postVisitDeepPathDatasetBlob((PathDatasetBlob) b);
        }
        if (b instanceof PathDatasetComponentBlob) {
            return (T) postVisitDeepPathDatasetComponentBlob((PathDatasetComponentBlob) b);
        }
        if (b instanceof PathDatasetComponentDiff) {
            return (T) postVisitDeepPathDatasetComponentDiff((PathDatasetComponentDiff) b);
        }
        if (b instanceof PathDatasetDiff) {
            return (T) postVisitDeepPathDatasetDiff((PathDatasetDiff) b);
        }
        if (b instanceof PythonEnvironmentBlob) {
            return (T) postVisitDeepPythonEnvironmentBlob((PythonEnvironmentBlob) b);
        }
        if (b instanceof PythonEnvironmentDiff) {
            return (T) postVisitDeepPythonEnvironmentDiff((PythonEnvironmentDiff) b);
        }
        if (b instanceof PythonRequirementEnvironmentBlob) {
            return (T) postVisitDeepPythonRequirementEnvironmentBlob((PythonRequirementEnvironmentBlob) b);
        }
        if (b instanceof PythonRequirementEnvironmentDiff) {
            return (T) postVisitDeepPythonRequirementEnvironmentDiff((PythonRequirementEnvironmentDiff) b);
        }
        if (b instanceof S3DatasetBlob) {
            return (T) postVisitDeepS3DatasetBlob((S3DatasetBlob) b);
        }
        if (b instanceof S3DatasetComponentBlob) {
            return (T) postVisitDeepS3DatasetComponentBlob((S3DatasetComponentBlob) b);
        }
        if (b instanceof S3DatasetComponentDiff) {
            return (T) postVisitDeepS3DatasetComponentDiff((S3DatasetComponentDiff) b);
        }
        if (b instanceof S3DatasetDiff) {
            return (T) postVisitDeepS3DatasetDiff((S3DatasetDiff) b);
        }
        if (b instanceof VersionEnvironmentBlob) {
            return (T) postVisitDeepVersionEnvironmentBlob((VersionEnvironmentBlob) b);
        }
        if (b instanceof VersionEnvironmentDiff) {
            return (T) postVisitDeepVersionEnvironmentDiff((VersionEnvironmentDiff) b);
        }
        return b;
    }
}

...
public class Visitor {
  ...
  public <T> T genericPostVisitDeep(T b) throws ModelDBException {
    ...
    if (b instanceof DiscreteHyperparameterSetConfigBlob) {
      return (T)
          postVisitDeepDiscreteHyperparameterSetConfigBlob((DiscreteHyperparameterSetConfigBlob) b);
    }
    ...
    if (b instanceof PythonRequirementEnvironmentBlob) {
      return (T)
          postVisitDeepPythonRequirementEnvironmentBlob((PythonRequirementEnvironmentBlob) b);
    }
    if (b instanceof PythonRequirementEnvironmentDiff) {
      return (T)
          postVisitDeepPythonRequirementEnvironmentDiff((PythonRequirementEnvironmentDiff) b);
    }

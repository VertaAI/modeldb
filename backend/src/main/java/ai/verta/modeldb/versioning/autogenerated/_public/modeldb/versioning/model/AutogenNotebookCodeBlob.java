...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenNotebookCodeBlob setGitRepo(AutogenGitCodeBlob
 value) {
 ...
 getGitRepo() {
    ...
    public AutogenNotebookCodeBlob setPath(AutogenPathDatasetComponentBlob
 value) {
 ...
 getPath() {
    ...
    static public AutogenNotebookCodeBlob fromProto(ai.verta.modeldb.versioning.NotebookCodeBlob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.NotebookCodeBlob,AutogenGitCodeBlob
> f = x -> AutogenGitCodeBlob.fromProto(blob.getGitRepo());
            obj.setGitRepo(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.NotebookCodeBlob,AutogenPathDatasetComponentBlob
...
(this.Path);
    ...
    public AutogenNotebookCodeBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setGitRepo(visitor.postVisitDeepAutogenGitCodeBlob
(this.GitRepo));

...
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenGitCodeDiff setA(AutogenGitCodeBlob
 value) {
 ...
 getA() {
    ...
    public AutogenGitCodeDiff setB(AutogenGitCodeBlob
 value) {
 ...
 getB() {
    ...
    public AutogenGitCodeDiff setC(AutogenGitCodeBlob
 value) {
 ...
 getC() {
    ...
    public AutogenGitCodeDiff setStatus(AutogenDiffStatusEnumDiffStatus
 value) {
 ...
 getStatus() {
    ...
    static public AutogenGitCodeDiff fromProto(ai.verta.modeldb.versioning.GitCodeDiff blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.GitCodeDiff,AutogenGitCodeBlob
> f = x -> AutogenGitCodeBlob.fromProto(blob.getA());
            obj.setA(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.GitCodeDiff,AutogenGitCodeBlob
> f = x -> AutogenGitCodeBlob.fromProto(blob.getB());
            obj.setB(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.GitCodeDiff,AutogenGitCodeBlob
> f = x -> AutogenGitCodeBlob.fromProto(blob.getC());
            obj.setC(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.GitCodeDiff,AutogenDiffStatusEnumDiffStatus
> f = x -> AutogenDiffStatusEnumDiffStatus.fromProto(blob.getStatus());
    ...
    public ai.verta.modeldb.versioning.GitCodeDiff.Builder toProto() {
        ...
        {
            if (this.C != null && !this.C.equals(null) ) {
                Function<ai.verta.modeldb.versioning.GitCodeDiff.Builder,Void> f = x -> { builder.setC(this.C.toProto()); return null; };
                f.apply(builder);
            }
        }
        {
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenGitCodeBlob
(this.A);
        visitor.preVisitDeepAutogenGitCodeBlob
(this.B);
        visitor.preVisitDeepAutogenGitCodeBlob
...
(this.Status);
    ...
    public AutogenGitCodeDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setA(visitor.postVisitDeepAutogenGitCodeBlob
(this.A));
        this.setB(visitor.postVisitDeepAutogenGitCodeBlob
(this.B));
        this.setC(visitor.postVisitDeepAutogenGitCodeBlob
(this.C));

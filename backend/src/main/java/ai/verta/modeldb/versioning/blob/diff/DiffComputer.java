...
import static ai.verta.modeldb.versioning.blob.diff.Utils.getOrNull;
import static ai.verta.modeldb.versioning.blob.diff.Utils.removeEmpty;
...
public class DiffComputer {
  public static <B, F, R> R computeDiff(
    ...
    return removeEmpty(computer.apply(getOrNull(a, getter), getOrNull(b, getter)));
  }

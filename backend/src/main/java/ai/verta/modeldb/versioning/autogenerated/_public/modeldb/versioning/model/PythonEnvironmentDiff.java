...
public class PythonEnvironmentDiff implements ProtoType {
    ...
    public Boolean isEmpty() {
        if (this.VersionStatus != null && !this.VersionStatus.equals(null) ) {
            return false;
        }
        if (this.VersionA != null && !this.VersionA.equals(null) ) {
            return false;
        }
        if (this.VersionB != null && !this.VersionB.equals(null) ) {
            return false;
        }
    ...
    public PythonEnvironmentDiff postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setVersionStatus(visitor.postVisitDeepDiffStatusEnumDiffStatus(this.VersionStatus));
        this.setVersionA(visitor.postVisitDeepVersionEnvironmentBlob(this.VersionA));
        this.setVersionB(visitor.postVisitDeepVersionEnvironmentBlob(this.VersionB));
        this.setRequirements(visitor.postVisitDeepListOfPythonRequirementEnvironmentDiff(this.Requirements));
        this.setConstraints(visitor.postVisitDeepListOfPythonRequirementEnvironmentDiff(this.Constraints));

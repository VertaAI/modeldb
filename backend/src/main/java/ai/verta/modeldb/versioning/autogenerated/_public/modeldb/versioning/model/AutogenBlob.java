...
public class AutogenBlob implements ProtoType {
    private AutogenCodeBlob
 Code;
    private AutogenConfigBlob
 Config;
    private AutogenDatasetBlob
 Dataset;
    private AutogenEnvironmentBlob
 Environment;
...
,Boolean> f = (x, y) -> x.equals(y);
        ...
        {
            Function3<AutogenEnvironmentBlob
,AutogenEnvironmentBlob
,Boolean> f = (x, y) -> x.equals(y);
    ...
    public AutogenBlob setCode(AutogenCodeBlob
 value) {
 ...
 getCode() {
    ...
    public AutogenBlob setConfig(AutogenConfigBlob
 value) {
 ...
 getConfig() {
    ...
    public AutogenBlob setDataset(AutogenDatasetBlob
 value) {
 ...
 getDataset() {
    ...
    public AutogenBlob setEnvironment(AutogenEnvironmentBlob
 value) {
 ...
 getEnvironment() {
    ...
    static public AutogenBlob fromProto(ai.verta.modeldb.versioning.Blob blob) {
        if (blob == null) {
            return null;
        }
        ...
        {
            Function<ai.verta.modeldb.versioning.Blob,AutogenCodeBlob
> f = x -> AutogenCodeBlob.fromProto(blob.getCode());
            obj.setCode(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.Blob,AutogenConfigBlob
> f = x -> AutogenConfigBlob.fromProto(blob.getConfig());
            obj.setConfig(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.Blob,AutogenDatasetBlob
> f = x -> AutogenDatasetBlob.fromProto(blob.getDataset());
            obj.setDataset(f.apply(blob));
        }
        {
            Function<ai.verta.modeldb.versioning.Blob,AutogenEnvironmentBlob
> f = x -> AutogenEnvironmentBlob.fromProto(blob.getEnvironment());
    ...
    public void preVisitDeep(Visitor visitor) throws ModelDBException {
        ...
        visitor.preVisitDeepAutogenCodeBlob
(this.Code);
        visitor.preVisitDeepAutogenConfigBlob
(this.Config);
        visitor.preVisitDeepAutogenDatasetBlob
(this.Dataset);
        visitor.preVisitDeepAutogenEnvironmentBlob
(this.Environment);
    }
    ...
    public AutogenBlob postVisitDeep(Visitor visitor) throws ModelDBException {
        this.setCode(visitor.postVisitDeepAutogenCodeBlob
(this.Code));
        this.setConfig(visitor.postVisitDeepAutogenConfigBlob
(this.Config));
        this.setDataset(visitor.postVisitDeepAutogenDatasetBlob
(this.Dataset));
        this.setEnvironment(visitor.postVisitDeepAutogenEnvironmentBlob
(this.Environment));

 ...
 *
 * Modified class io.grpc.services.HealthStatusManager
 ...
 * created in the constructor of {@code HealthStatusManager}, and it can be retrieved by the {@link
 * #getHealthService()} method. The health status manager can update the health statuses of the
 * server.
 */

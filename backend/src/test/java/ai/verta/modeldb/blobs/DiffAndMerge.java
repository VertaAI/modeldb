...
public class DiffAndMerge {
  ...
  public void diffAndMergeAutogenCode(AutogenCodeBlob a, AutogenCodeBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeCode(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenConfig(AutogenConfigBlob a, AutogenConfigBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeConfig(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenDataset(AutogenDatasetBlob a, AutogenDatasetBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeDataset(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenDockerEnvironment(
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeDockerEnvironment(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenEnvironment(AutogenEnvironmentBlob a, AutogenEnvironmentBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeEnvironment(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenGitCode(AutogenGitCodeBlob a, AutogenGitCodeBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeGitCode(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenNotebookCode(AutogenNotebookCodeBlob a, AutogenNotebookCodeBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeNotebookCode(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenPathDataset(AutogenPathDatasetBlob a, AutogenPathDatasetBlob b)
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergePathDataset(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenPythonEnvironment(
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergePythonEnvironment(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }

  @Property
  public void diffAndMergeAutogenS3Dataset(
      @When(seed = -7576660054998480892L) AutogenS3DatasetBlob a,
      @When(seed = 6965113640460202269L) AutogenS3DatasetBlob b)
      throws ModelDBException {
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeS3Dataset(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
  ...
  public void diffAndMergeAutogenVersionEnvironment(
    ...
    // Reapplying the diff should not change the result
    diffedB = DiffMerger.mergeVersionEnvironment(diffedB, d, new HashSet<String>());
    assertEquals(newB, diffedB);
  }
}

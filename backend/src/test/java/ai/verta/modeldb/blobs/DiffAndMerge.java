...
public class DiffAndMerge {
    ...
    @Property public void diffAndMergeAutogenCode(AutogenCodeBlob a, AutogenCodeBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenConfig(AutogenConfigBlob a, AutogenConfigBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenDataset(AutogenDatasetBlob a, AutogenDatasetBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenDockerEnvironment(AutogenDockerEnvironmentBlob a, AutogenDockerEnvironmentBlob b) throws ModelDBException {
        ...
        // Applying the diff on top of the original A should get original B
        AutogenDockerEnvironmentBlob diffedB = DiffMerger.mergeDockerEnvironment(newA, d, new HashSet<String>());
        assertEquals(newB, diffedB);
    ...
    @Property public void diffAndMergeAutogenEnvironment(AutogenEnvironmentBlob a, AutogenEnvironmentBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenGitCode(AutogenGitCodeBlob a, AutogenGitCodeBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenNotebookCode(AutogenNotebookCodeBlob a, AutogenNotebookCodeBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenPathDataset(AutogenPathDatasetBlob a, AutogenPathDatasetBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenPythonEnvironment(AutogenPythonEnvironmentBlob a, AutogenPythonEnvironmentBlob b) throws ModelDBException {
        ...
        // Applying the diff on top of the original A should get original B
        AutogenPythonEnvironmentBlob diffedB = DiffMerger.mergePythonEnvironment(newA, d, new HashSet<String>());
        assertEquals(newB, diffedB);
    ...
    @Property public void diffAndMergeAutogenS3Dataset(AutogenS3DatasetBlob a, AutogenS3DatasetBlob b) throws ModelDBException {
    ...
    @Property public void diffAndMergeAutogenVersionEnvironment(AutogenVersionEnvironmentBlob a, AutogenVersionEnvironmentBlob b) throws ModelDBException {
        ...
        // Applying the diff on top of the original A should get original B
        AutogenVersionEnvironmentBlob diffedB = DiffMerger.mergeVersionEnvironment(newA, d, new HashSet<String>());
        assertEquals(newB, diffedB);

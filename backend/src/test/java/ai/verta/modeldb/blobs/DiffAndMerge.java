...
public class DiffAndMerge {
  ...
  public void diffAndMerge(AutogenBlob a, AutogenBlob b) throws ModelDBException {
    ...
    assertEquals(Utils.removeEmpty(newB), diffedB);
  ...
  @Property
  public void diffAndMergeAutogenDataset(
      @When(seed = 2994728865789160542L) AutogenDatasetBlob a,
      @When(seed = 7136618417407418110L) AutogenDatasetBlob b)
      throws ModelDBException {

...
public class DiffAndMerge {
  ...
  //
  //    // Applying the diff on top of the original A should get original B
  //    AutogenEnvironmentBlob diffedB = DiffMerger.mergeEnvironment(newA, d, new
  // HashSet<String>());
  //    assertEquals(newB, diffedB);
  //
  //    HashSet<String> conflictSet = new HashSet<String>();
  ...
  //
  //  @Property
  //  public void diffAndMergeAutogenNotebookCode(AutogenNotebookCodeBlob a, AutogenNotebookCodeBlob
  // b)
  //      throws ModelDBException {
  ...
  //
  //    // Applying the diff on top of the original A should get original B
  //    AutogenNotebookCodeBlob diffedB = DiffMerger.mergeNotebookCode(newA, d, new
  // HashSet<String>());
  //    assertEquals(newB, diffedB);
  //
  //    HashSet<String> conflictSet = new HashSet<String>();
  ...
  //
  //    // Applying the diff on top of the original A should get original B
  //    AutogenPathDatasetBlob diffedB = DiffMerger.mergePathDataset(newA, d, new
  // HashSet<String>());
  //    assertEquals(newB, diffedB);
  //
  //    HashSet<String> conflictSet = new HashSet<String>();

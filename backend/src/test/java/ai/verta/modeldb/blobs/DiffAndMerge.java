...
public class DiffAndMerge {
  ...
  @Property
  public void diffAndMergeAutogenEnvironment(
      @When(seed = 8322451775817921411L) AutogenEnvironmentBlob a,
      @When(seed = -1984586775709033943L) AutogenEnvironmentBlob b)
      throws ModelDBException {

...
public class BlobProtoEquality {
  ...
  @Property
  public void protoEqualityAutogenGetUrlForVersionedBlob(AutogenGetUrlForVersionedBlob b)
      throws ModelDBException {
    AutogenGetUrlForVersionedBlob newb = enforceOneof(b);
    AutogenGetUrlForVersionedBlob other =
        newb == null ? null : AutogenGetUrlForVersionedBlob.fromProto(newb.toProto().build());
    assertEquals(newb, other);
  }

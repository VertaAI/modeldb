...
public class FindDatasetEntitiesTest {
  ...
  //          assertTrue(
  //              "Dataset attributes.attribute_1 not match with expected dataset
  ...
  //          assertTrue(
  //              "Dataset not match with expected dataset",
  // datasetMap.containsKey(dataset.getId()));
  //
  //          if (count == 0) {
  //            assertEquals(
  //                "Dataset name not match with expected dataset name",
  ...
  //    LOGGER.info("Find and sort Datasets by attributes test
  // start................................");
  //
  ...
  //          doesAttributeExist = true;
  //          assertTrue(
  //              "DatasetVersion attributes.attribute_1 not match with expected datasetVersion
  // attributes.attribute_1",
  //              fetchedAttribute.getValue().getNumberValue() <= 0.6543210);
  //        }
  //      }
  ...
  //    LOGGER.info("FindDatasetVersions not support the observation.attributes test
  // start........");
  //
  //    Value numValue = Value.newBuilder().setNumberValue(0.31).build();
  //    KeyValueQuery keyValueQuery2 =

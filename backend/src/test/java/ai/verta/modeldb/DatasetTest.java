...
public class DatasetTest {
  ...
  //                  == status.getCode()); // because of shadow delete the response could be 403 or
  // 404
  //    } else {
  ...
  //              .build();
  //
  //      GetAllDatasets.Response datasetResponse =
  // datasetServiceStub.getAllDatasets(getAllDatasets);
  //
  //      assertEquals(
  ...
  //          assertEquals(
  //              "Dataset not match with expected Dataset", datasetsMap.get(dataset.getId()),
  // dataset);
  //        }
  //
  //        if (pageNumber == 1) {
  ...
  //    assertEquals(
  //        "Dataset not match with expected dataset", dataset,
  // getDatasetByIdResponse.getDataset());
  //
  //    DeleteDataset deleteDataset = DeleteDataset.newBuilder().setId(dataset.getId()).build();
  //    DeleteDataset.Response deleteDatasetResponse =
  // datasetServiceStub.deleteDataset(deleteDataset);
  ...
  //    LOGGER.info("Response SharedDatasetsList of Datasets : " +
  // response.getSharedDatasetsList());
  //    assertEquals(
  ...
  //        assertEquals("Shared dataset name not match", dataset.getName(),
  // sharedDataset.getName());
  //      }
  //
  //      // Create dataset
  ...
  //    LOGGER.info("Get Dataset by name with workspace test
  // start................................");
  //    if (app.getAuthServerHost() == null || app.getAuthServerPort() == null) {
  //      assertTrue(true);
  //      return;
  ...
  //
  //    updateDescriptionRequest =
  // UpdateDatasetDescription.newBuilder().setId(dataset.getId()).build();
  //
  //    response = datasetServiceStub.updateDatasetDescription(updateDescriptionRequest);
  //    LOGGER.info("UpdateDatasetDescription Response : " + response.getDataset());
  //    assertEquals(
  ...
  //    LOGGER.info("Update Dataset Description Negative test
  // start................................");
  //
  //    DatasetServiceGrpc.DatasetServiceBlockingStub datasetServiceStub =
  //        DatasetServiceGrpc.newBlockingStub(channel);
  ...
  //    AddDatasetTags addDatasetTagsRequest =
  // AddDatasetTags.newBuilder().addAllTags(tagsList).build();
  //
  //    try {
  //      datasetServiceStub.addDatasetTags(addDatasetTagsRequest);
  //      fail();
  ...
  //    LOGGER.info("Update Dataset Attributes Negative test
  // start................................");
  //
  //    DatasetServiceBlockingStub datasetServiceStub = DatasetServiceGrpc.newBlockingStub(channel);
  //
  ...
  //    LOGGER.info("Delete Dataset Attributes Negative test
  // start................................");
  //
  //    DatasetServiceBlockingStub datasetServiceStub = DatasetServiceGrpc.newBlockingStub(channel);
  //

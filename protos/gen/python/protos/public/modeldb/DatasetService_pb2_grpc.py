...
class DatasetServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.setDatasetWorkspace = channel.unary_unary(
        ...
        request_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.SetDatasetWorkspace.SerializeToString,
        response_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.SetDatasetWorkspace.Response.FromString,
        )
...
def add_DatasetServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'setDatasetWorkspace': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.SetDatasetWorkspace.FromString,
          response_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.SetDatasetWorkspace.Response.SerializeToString,
      ),
  }

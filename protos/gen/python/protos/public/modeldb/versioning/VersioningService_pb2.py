...
_VERSIONINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\320\001\022\201\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch=**}ZJ\022H/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch=**}',
  ),
  _descriptor.MethodDescriptor(
    name='SetBranch',
    ...
    serialized_options=b'\202\323\344\223\002\350\001\032\201\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch=**}:\ncommit_shaZV\032H/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch=**}:\ncommit_sha',
  ),
  _descriptor.MethodDescriptor(
    name='DeleteBranch',
    ...
    serialized_options=b'\202\323\344\223\002\320\001*\201\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch=**}ZJ*H/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch=**}',
  ),
  _descriptor.MethodDescriptor(
    name='ListCommitsLog',
    ...
    serialized_options=b'\202\323\344\223\002\263\003\022\205\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch=**}/logZN\022L/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch=**}/logZ\210\001\022\205\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/commits/{commit_sha}/logZN\022L/v1/versioning/repositories/{repository_id.repo_id}/commits/{commit_sha}/log',
  ),
  _descriptor.MethodDescriptor(

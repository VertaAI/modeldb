...
_COMPUTEREPOSITORYDIFFREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='replace_a_with_common_ancestor', full_name='ai.verta.modeldb.versioning.ComputeRepositoryDiffRequest.replace_a_with_common_ancestor', index=4,
...
_REVERTREPOSITORYCOMMITSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='commit_sha', full_name='ai.verta.modeldb.versioning.RevertRepositoryCommitsRequest.commit_sha', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='content', full_name='ai.verta.modeldb.versioning.RevertRepositoryCommitsRequest.content', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VERSIONINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\336\001\"\210\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/commits/{commit_sha}/revertZQ\"O/v1/versioning/repositories/{repository_id.repo_id}/commits/{commit_sha}/revert',
  ),
  _descriptor.MethodDescriptor(
    name='ListTags',

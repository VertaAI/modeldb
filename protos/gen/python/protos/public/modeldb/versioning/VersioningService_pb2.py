...
_REPOSITORY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='owner', full_name='ai.verta.modeldb.versioning.Repository.owner', index=7,
...
_GETURLFORVERSIONEDBLOB_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.Response.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETURLFORVERSIONEDBLOB = _descriptor.Descriptor(
  name='GetUrlForVersionedBlob',
  full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='repository_id', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.repository_id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='commit_sha', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.commit_sha', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='location', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.location', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='path_dataset_component_blob_path', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.path_dataset_component_blob_path', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.method', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='part_number', full_name='ai.verta.modeldb.versioning.GetUrlForVersionedBlob.part_number', index=5,
  ...
  nested_types=[_GETURLFORVERSIONEDBLOB_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_GETURLFORVERSIONEDBLOB_RESPONSE.containing_type = _GETURLFORVERSIONEDBLOB
_GETURLFORVERSIONEDBLOB.fields_by_name['repository_id'].message_type = _REPOSITORYIDENTIFICATION
...
DESCRIPTOR.message_types_by_name['GetUrlForVersionedBlob'] = _GETURLFORVERSIONEDBLOB
...
GetUrlForVersionedBlob = _reflection.GeneratedProtocolMessageType('GetUrlForVersionedBlob', (_message.Message,), {

  'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
    'DESCRIPTOR' : _GETURLFORVERSIONEDBLOB_RESPONSE,
    '__module__' : 'modeldb.versioning.VersioningService_pb2'
    # @@protoc_insertion_point(class_scope:ai.verta.modeldb.versioning.GetUrlForVersionedBlob.Response)
    })
  ,
  'DESCRIPTOR' : _GETURLFORVERSIONEDBLOB,
  '__module__' : 'modeldb.versioning.VersioningService_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.modeldb.versioning.GetUrlForVersionedBlob)
  })
_sym_db.RegisterMessage(GetUrlForVersionedBlob)
_sym_db.RegisterMessage(GetUrlForVersionedBlob.Response)
...
_VERSIONINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getUrlForVersionedBlob',
    full_name='ai.verta.modeldb.versioning.VersioningService.getUrlForVersionedBlob',
    index=27,
    containing_service=None,
    input_type=_GETURLFORVERSIONEDBLOB,
    output_type=_GETURLFORVERSIONEDBLOB_RESPONSE,
    serialized_options=b'\202\323\344\223\002\204\002\"\230\001/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/commits/{commit_sha}/getUrlForVersionedBlob:\001*Zd\"_/v1/versioning/repositories/{repository_id.repo_id}/commits/{commit_sha}/getUrlForVersionedBlob:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='commitVersionedBlobArtifactPart',

...
_MODELDATADIFFMETADATA = _descriptor.Descriptor(
  name='ModelDataDiffMetadata',
  full_name='ai.verta.modeldb.data.ModelDataDiffMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='start_time_millis', full_name='ai.verta.modeldb.data.ModelDataDiffMetadata.start_time_millis', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time_millis', full_name='ai.verta.modeldb.data.ModelDataDiffMetadata.end_time_millis', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_id_a', full_name='ai.verta.modeldb.data.ModelDataDiffMetadata.model_id_a', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_id_b', full_name='ai.verta.modeldb.data.ModelDataDiffMetadata.model_id_b', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoint', full_name='ai.verta.modeldb.data.ModelDataDiffMetadata.endpoint', index=4,
...
DESCRIPTOR.message_types_by_name['ModelDataDiffMetadata'] = _MODELDATADIFFMETADATA
...
ModelDataDiffMetadata = _reflection.GeneratedProtocolMessageType('ModelDataDiffMetadata', (_message.Message,), {
  'DESCRIPTOR' : _MODELDATADIFFMETADATA,
  '__module__' : 'modeldb.data.ModelData_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.modeldb.data.ModelDataDiffMetadata)
  })
_sym_db.RegisterMessage(ModelDataDiffMetadata)

...
_ORGANIZATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_monitored_entity_collaborator_type', full_name='ai.verta.uac.Organization.default_monitored_entity_collaborator_type', index=15,

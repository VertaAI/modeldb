...
_COLLECTTELEMETRY.fields_by_name['metrics'].message_type = protos_dot_public_dot_common_dot_CommonService__pb2._KEYVALUE
DESCRIPTOR.message_types_by_name['CollectTelemetry'] = _COLLECTTELEMETRY
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CollectTelemetry = _reflection.GeneratedProtocolMessageType('CollectTelemetry', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _COLLECTTELEMETRY_RESPONSE,
    __module__ = 'protos.public.uac.Telemetry_pb2'
...
_TELEMETRYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002#\"\036/v1/telemetry/collectTelemetry:\001*'),
  ),
])

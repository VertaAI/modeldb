...
// All implementations must embed UnimplementedDatasetVersionServiceServer
...
type DatasetVersionServiceServer interface {
	...
	mustEmbedUnimplementedDatasetVersionServiceServer()
}

// UnimplementedDatasetVersionServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedDatasetVersionServiceServer) mustEmbedUnimplementedDatasetVersionServiceServer() {}

// UnsafeDatasetVersionServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to DatasetVersionServiceServer will
// result in compilation errors.
type UnsafeDatasetVersionServiceServer interface {
	mustEmbedUnimplementedDatasetVersionServiceServer()
}

func RegisterDatasetVersionServiceServer(s grpc.ServiceRegistrar, srv DatasetVersionServiceServer) {
	s.RegisterService(&DatasetVersionService_ServiceDesc, srv)
}
...
// DatasetVersionService_ServiceDesc is the grpc.ServiceDesc for DatasetVersionService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var DatasetVersionService_ServiceDesc = grpc.ServiceDesc{

...
var (
	filter_RegistryService_CreateExternalDeployment_0 = &utilities.DoubleArray{Encoding: map[string]int{"external_deployment": 0, "model_version_id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	filter_RegistryService_UpdateExternalDeployment_0 = &utilities.DoubleArray{Encoding: map[string]int{"external_deployment": 0, "external_deployment_id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	...
	pattern_RegistryService_GetExternalDeployment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "registry", "external_deployments", "external_deployment_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_RegistryService_CreateExternalDeployment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"v1", "registry", "registered_models", "model_versions", "model_version_id", "external_deployments"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_RegistryService_UpdateExternalDeployment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"v1", "registry", "registered_models", "model_versions", "external_deployments", "external_deployment_id"}, "", runtime.AssumeColonVerbOpt(true)))

...
type RegisteredModel struct {
	...
	// Legacy id of the workspace this belongs to
	LegacyWorkspaceId string `protobuf:"bytes,8,opt,name=legacy_workspace_id,json=legacyWorkspaceId,proto3" json:"legacy_workspace_id,omitempty"`
	//readme
	...
	// id of the workspace that this ``registered_model`` belongs to
	WorkspaceId uint64 `protobuf:"varint,12,opt,name=workspace_id,json=workspaceId,proto3" json:"workspace_id,omitempty"`
}
...
func (x *RegisteredModel) GetLegacyWorkspaceId() string {
	if x != nil {
		return x.LegacyWorkspaceId
	}
	return ""
}
...
func (x *RegisteredModel) GetWorkspaceId() uint64 {
	if x != nil {
...
var file_registry_RegistryService_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc6, 0x03, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x2e, 0x0a, 0x13, 0x6c, 0x65, 0x67,
	0x61, 0x63, 0x79, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x57, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x61,
	0x64, 0x6d, 0x65, 0x5f, 0x74, 0x65, 0x78, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x72, 0x65, 0x61, 0x64, 0x6d, 0x65, 0x54, 0x65, 0x78, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77,
	...
	0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x77,
	0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x22, 0xfc,
	...
	0x65, 0x79, 0x1a, 0x0a, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xad,
	0x27, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x0d, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0xb4,
	...
	0x61, 0x72, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x3a, 0x01, 0x2a, 0x42, 0x43,
...
var file_registry_RegistryService_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_registry_RegistryService_proto_goTypes = []interface{}{
	...
	nil,                                           // 26: ai.verta.registry.GetUrlForArtifact.Response.FieldsEntry
	(*CommitArtifactPart_Response)(nil),           // 27: ai.verta.registry.CommitArtifactPart.Response
	(*GetCommittedArtifactParts_Response)(nil),    // 28: ai.verta.registry.GetCommittedArtifactParts.Response
	(*CommitMultipartArtifact_Response)(nil),      // 29: ai.verta.registry.CommitMultipartArtifact.Response
	(common.VisibilityEnum_Visibility)(0),         // 30: ai.verta.common.VisibilityEnum.Visibility
	(*common.KeyValue)(nil),                       // 31: ai.verta.common.KeyValue
	(*common.KeyValueQuery)(nil),                  // 32: ai.verta.common.KeyValueQuery
	(*common.Pagination)(nil),                     // 33: ai.verta.common.Pagination
	(*field_mask.FieldMask)(nil),                  // 34: google.protobuf.FieldMask
	(*common.Artifact)(nil),                       // 35: ai.verta.common.Artifact
	(*versioning.EnvironmentBlob)(nil),            // 36: ai.verta.modeldb.versioning.EnvironmentBlob
	(common.TernaryEnum_Ternary)(0),               // 37: ai.verta.common.TernaryEnum.Ternary
	(common.ArtifactTypeEnum_ArtifactType)(0),     // 38: ai.verta.common.ArtifactTypeEnum.ArtifactType
	(*common.ArtifactPart)(nil),                   // 39: ai.verta.common.ArtifactPart
}
var file_registry_RegistryService_proto_depIdxs = []int32{
	30, // 0: ai.verta.registry.RegisteredModel.visibility:type_name -> ai.verta.common.VisibilityEnum.Visibility
	31, // 1: ai.verta.registry.RegisteredModel.attributes:type_name -> ai.verta.common.KeyValue
	32, // 2: ai.verta.registry.FindRegisteredModelRequest.predicates:type_name -> ai.verta.common.KeyValueQuery
	33, // 3: ai.verta.registry.FindRegisteredModelRequest.pagination:type_name -> ai.verta.common.Pagination
	...
	34, // 8: ai.verta.registry.SetRegisteredModel.update_mask:type_name -> google.protobuf.FieldMask
	4,  // 9: ai.verta.registry.DeleteRegisteredModelRequest.id:type_name -> ai.verta.registry.RegisteredModelIdentification
	35, // 10: ai.verta.registry.ModelVersion.model:type_name -> ai.verta.common.Artifact
	36, // 11: ai.verta.registry.ModelVersion.environment:type_name -> ai.verta.modeldb.versioning.EnvironmentBlob
	35, // 12: ai.verta.registry.ModelVersion.artifacts:type_name -> ai.verta.common.Artifact
	37, // 13: ai.verta.registry.ModelVersion.archived:type_name -> ai.verta.common.TernaryEnum.Ternary
	31, // 14: ai.verta.registry.ModelVersion.attributes:type_name -> ai.verta.common.KeyValue
	...
	32, // 18: ai.verta.registry.FindModelVersionRequest.predicates:type_name -> ai.verta.common.KeyValueQuery
	33, // 19: ai.verta.registry.FindModelVersionRequest.pagination:type_name -> ai.verta.common.Pagination
	...
	34, // 22: ai.verta.registry.SetModelVersion.update_mask:type_name -> google.protobuf.FieldMask
	8,  // 23: ai.verta.registry.DeleteModelVersionRequest.id:type_name -> ai.verta.registry.ModelVersionIdentification
	38, // 24: ai.verta.registry.GetUrlForArtifact.artifact_type:type_name -> ai.verta.common.ArtifactTypeEnum.ArtifactType
	39, // 25: ai.verta.registry.CommitArtifactPart.artifact_part:type_name -> ai.verta.common.ArtifactPart
	...
	26, // 32: ai.verta.registry.GetUrlForArtifact.Response.fields:type_name -> ai.verta.registry.GetUrlForArtifact.Response.FieldsEntry
	39, // 33: ai.verta.registry.GetCommittedArtifactParts.Response.artifact_parts:type_name -> ai.verta.common.ArtifactPart
	1,  // 34: ai.verta.registry.RegistryService.FindRegisteredModel:input_type -> ai.verta.registry.FindRegisteredModelRequest
	2,  // 35: ai.verta.registry.RegistryService.GetRegisteredModel:input_type -> ai.verta.registry.GetRegisteredModelRequest
	5,  // 36: ai.verta.registry.RegistryService.CreateRegisteredModel:input_type -> ai.verta.registry.SetRegisteredModel
	5,  // 37: ai.verta.registry.RegistryService.UpdateRegisteredModel:input_type -> ai.verta.registry.SetRegisteredModel
	6,  // 38: ai.verta.registry.RegistryService.DeleteRegisteredModel:input_type -> ai.verta.registry.DeleteRegisteredModelRequest
	10, // 39: ai.verta.registry.RegistryService.FindModelVersion:input_type -> ai.verta.registry.FindModelVersionRequest
	9,  // 40: ai.verta.registry.RegistryService.GetModelVersion:input_type -> ai.verta.registry.GetModelVersionRequest
	11, // 41: ai.verta.registry.RegistryService.CreateModelVersion:input_type -> ai.verta.registry.SetModelVersion
	11, // 42: ai.verta.registry.RegistryService.UpdateModelVersion:input_type -> ai.verta.registry.SetModelVersion
	12, // 43: ai.verta.registry.RegistryService.DeleteModelVersion:input_type -> ai.verta.registry.DeleteModelVersionRequest
	13, // 44: ai.verta.registry.RegistryService.getUrlForArtifact:input_type -> ai.verta.registry.GetUrlForArtifact
	14, // 45: ai.verta.registry.RegistryService.commitArtifactPart:input_type -> ai.verta.registry.CommitArtifactPart
	15, // 46: ai.verta.registry.RegistryService.getCommittedArtifactParts:input_type -> ai.verta.registry.GetCommittedArtifactParts
	16, // 47: ai.verta.registry.RegistryService.commitMultipartArtifact:input_type -> ai.verta.registry.CommitMultipartArtifact
	17, // 48: ai.verta.registry.RegistryService.FindRegisteredModel:output_type -> ai.verta.registry.FindRegisteredModelRequest.Response
	18, // 49: ai.verta.registry.RegistryService.GetRegisteredModel:output_type -> ai.verta.registry.GetRegisteredModelRequest.Response
	19, // 50: ai.verta.registry.RegistryService.CreateRegisteredModel:output_type -> ai.verta.registry.SetRegisteredModel.Response
	19, // 51: ai.verta.registry.RegistryService.UpdateRegisteredModel:output_type -> ai.verta.registry.SetRegisteredModel.Response
	20, // 52: ai.verta.registry.RegistryService.DeleteRegisteredModel:output_type -> ai.verta.registry.DeleteRegisteredModelRequest.Response
	22, // 53: ai.verta.registry.RegistryService.FindModelVersion:output_type -> ai.verta.registry.FindModelVersionRequest.Response
	21, // 54: ai.verta.registry.RegistryService.GetModelVersion:output_type -> ai.verta.registry.GetModelVersionRequest.Response
	23, // 55: ai.verta.registry.RegistryService.CreateModelVersion:output_type -> ai.verta.registry.SetModelVersion.Response
	23, // 56: ai.verta.registry.RegistryService.UpdateModelVersion:output_type -> ai.verta.registry.SetModelVersion.Response
	24, // 57: ai.verta.registry.RegistryService.DeleteModelVersion:output_type -> ai.verta.registry.DeleteModelVersionRequest.Response
	25, // 58: ai.verta.registry.RegistryService.getUrlForArtifact:output_type -> ai.verta.registry.GetUrlForArtifact.Response
	27, // 59: ai.verta.registry.RegistryService.commitArtifactPart:output_type -> ai.verta.registry.CommitArtifactPart.Response
	28, // 60: ai.verta.registry.RegistryService.getCommittedArtifactParts:output_type -> ai.verta.registry.GetCommittedArtifactParts.Response
	29, // 61: ai.verta.registry.RegistryService.commitMultipartArtifact:output_type -> ai.verta.registry.CommitMultipartArtifact.Response

...
var (
	pattern_SummaryService_CreateSummary_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "summaries", "createSummary"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SummaryService_FindSummary_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "summaries", "findSummary"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SummaryService_DeleteSummary_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "summaries", "deleteSummary"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SummaryService_CreateSample_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "summaries", "createSample"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SummaryService_FindSample_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "summaries", "findSample"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SummaryService_DeleteSample_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "summaries", "deleteSample"}, "", runtime.AssumeColonVerbOpt(true)))
)

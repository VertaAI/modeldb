...
func request_DataMonitoringService_FindMonitoredEntity_0(ctx context.Context, marshaler runtime.Marshaler, client DataMonitoringServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_DataMonitoringService_FindMonitoredEntity_0(ctx context.Context, marshaler runtime.Marshaler, server DataMonitoringServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FindMonitoredEntityRequest
	var metadata runtime.ServerMetadata
...
func RegisterDataMonitoringServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DataMonitoringServiceServer) error {
	...
	mux.Handle("POST", pattern_DataMonitoringService_FindMonitoredEntity_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_DataMonitoringService_FindMonitoredEntity_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_DataMonitoringService_FindMonitoredEntity_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDataMonitoringServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DataMonitoringServiceClient) error {
	...
	mux.Handle("POST", pattern_DataMonitoringService_FindMonitoredEntity_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DataMonitoringService_FindMonitoredEntity_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_DataMonitoringService_CreateMonitoredEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "createMonitoredEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_UpdateMonitoredEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "updateMonitoredEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_FindMonitoredEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "findMonitoredEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_DeleteMonitoredEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "deleteMonitoredEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_GetProfiler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "getProfiler"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_CreateProfiler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "createProfiler"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_UpdateProfiler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "updateProfiler"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_ListProfilers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "listProfilers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_DeleteProfiler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "deleteProfile"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_GetProfilerStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "getProfilerStatus"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_FindProfilersForMonitoredEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "findProfilersForMonitoredEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_EnableProfiler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "enableProfiler"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataMonitoringService_DisableProfiler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "monitoring", "monitored_entity", "disableProfiler"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_DataMonitoringService_FindMonitoredEntity_0 = runtime.ForwardResponseMessage

...
const (
	...
	IdServiceProviderEnum_AD        IdServiceProviderEnum_IdServiceProvider = 6
)
...
var file_uac_UACService_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x7d, 0x0a, 0x15, 0x49, 0x64, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22,
	0x64, 0x0a, 0x11, 0x49, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x76,
	...
	0x41, 0x10, 0x04, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x41, 0x4d, 0x4c, 0x10, 0x05, 0x12, 0x06, 0x0a,
	0x02, 0x41, 0x44, 0x10, 0x06, 0x22, 0x36, 0x0a, 0x0d, 0x54, 0x72, 0x69, 0x61, 0x6c, 0x55, 0x73,
	0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x61, 0x79, 0x73, 0x5f, 0x72,
	0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d,
	0x64, 0x61, 0x79, 0x73, 0x52, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x22, 0x9b, 0x03,
	...
	0x0a, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1b, 0x2e, 0x61, 0x69, 0x2e, 0x76, 0x65, 0x72, 0x74, 0x61, 0x2e, 0x75, 0x61, 0x63,
	0x2e, 0x54, 0x72, 0x69, 0x61, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09,
	0x74, 0x72, 0x69, 0x61, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x30, 0x0a, 0x14, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69,
	0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x22, 0xad, 0x03, 0x0a, 0x08,
	...
	0x6e, 0x64, 0x61, 0x72, 0x79, 0x44, 0x65, 0x76, 0x4b, 0x65, 0x79, 0x22, 0x8c, 0x01, 0x0a, 0x0a,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0x2e, 0x0a, 0x08, 0x46, 0x6c, 0x61, 0x67, 0x45, 0x6e,
	...
	0x41, 0x4c, 0x53, 0x45, 0x10, 0x02, 0x32, 0x88, 0x08, 0x0a, 0x0a, 0x55, 0x41, 0x43, 0x53, 0x65,
	...
	0x65, 0x76, 0x4b, 0x65, 0x79, 0x3a, 0x01, 0x2a, 0x12, 0x51, 0x0a, 0x07, 0x67, 0x65, 0x74, 0x55,
...
var file_uac_UACService_proto_depIdxs = []int32{
	...
	3,  // 15: ai.verta.uac.UACService.getUser:input_type -> ai.verta.uac.GetUser
	4,  // 16: ai.verta.uac.UACService.getUsers:input_type -> ai.verta.uac.GetUsers
	6,  // 17: ai.verta.uac.UACService.getUsersFuzzy:input_type -> ai.verta.uac.GetUsersFuzzy
	11, // 18: ai.verta.uac.UACService.createUser:input_type -> ai.verta.uac.CreateUser
	12, // 19: ai.verta.uac.UACService.updateUser:input_type -> ai.verta.uac.UpdateUser
	13, // 20: ai.verta.uac.UACService.deleteUser:input_type -> ai.verta.uac.DeleteUser
	10, // 21: ai.verta.uac.UACService.getCurrentUser:output_type -> ai.verta.uac.UserInfo
	10, // 22: ai.verta.uac.UACService.addDevKey:output_type -> ai.verta.uac.UserInfo
	10, // 23: ai.verta.uac.UACService.deletePrimaryDevKey:output_type -> ai.verta.uac.UserInfo
	10, // 24: ai.verta.uac.UACService.deleteSecondaryDevKey:output_type -> ai.verta.uac.UserInfo
	10, // 25: ai.verta.uac.UACService.getUser:output_type -> ai.verta.uac.UserInfo
	14, // 26: ai.verta.uac.UACService.getUsers:output_type -> ai.verta.uac.GetUsers.Response
	15, // 27: ai.verta.uac.UACService.getUsersFuzzy:output_type -> ai.verta.uac.GetUsersFuzzy.Response
	16, // 28: ai.verta.uac.UACService.createUser:output_type -> ai.verta.uac.CreateUser.Response
	17, // 29: ai.verta.uac.UACService.updateUser:output_type -> ai.verta.uac.UpdateUser.Response
	18, // 30: ai.verta.uac.UACService.deleteUser:output_type -> ai.verta.uac.DeleteUser.Response

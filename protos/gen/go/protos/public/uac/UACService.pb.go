...
var file_uac_UACService_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x87, 0x03, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x17,
	...
	0x61, 0x49, 0x6e, 0x66, 0x6f, 0x4a, 0x04, 0x08, 0x0b, 0x10, 0x0c, 0x22, 0x8c, 0x01, 0x0a, 0x0a,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x8c, 0x01, 0x0a, 0x0a, 0x55,
	...
	0x64, 0x1a, 0x36, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x49, 0x0a, 0x0a, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f,
	...
	0x61, 0x74, 0x75, 0x73, 0x2a, 0x2e, 0x0a, 0x08, 0x46, 0x6c, 0x61, 0x67, 0x45, 0x6e, 0x75, 0x6d,
	...
	0x53, 0x45, 0x10, 0x02, 0x32, 0xd4, 0x05, 0x0a, 0x0a, 0x55, 0x41, 0x43, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x5d, 0x0a, 0x0e, 0x67, 0x65, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x61, 0x69, 0x2e, 0x76, 0x65, 0x72, 0x74, 0x61,
	...
	0x66, 0x6f, 0x22, 0x1e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x18, 0x12, 0x16, 0x2f, 0x76, 0x31, 0x2f,
	0x75, 0x61, 0x63, 0x2f, 0x67, 0x65, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x12, 0x51, 0x0a, 0x07, 0x67, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x15, 0x2e,
...
var file_uac_UACService_proto_depIdxs = []int32{
	...
	3,  // 12: ai.verta.uac.UACService.getUser:input_type -> ai.verta.uac.GetUser
	4,  // 13: ai.verta.uac.UACService.getUsers:input_type -> ai.verta.uac.GetUsers
	6,  // 14: ai.verta.uac.UACService.getUsersFuzzy:input_type -> ai.verta.uac.GetUsersFuzzy
	11, // 15: ai.verta.uac.UACService.createUser:input_type -> ai.verta.uac.CreateUser
	12, // 16: ai.verta.uac.UACService.updateUser:input_type -> ai.verta.uac.UpdateUser
	13, // 17: ai.verta.uac.UACService.deleteUser:input_type -> ai.verta.uac.DeleteUser
	10, // 18: ai.verta.uac.UACService.getCurrentUser:output_type -> ai.verta.uac.UserInfo
	10, // 19: ai.verta.uac.UACService.getUser:output_type -> ai.verta.uac.UserInfo
	14, // 20: ai.verta.uac.UACService.getUsers:output_type -> ai.verta.uac.GetUsers.Response
	15, // 21: ai.verta.uac.UACService.getUsersFuzzy:output_type -> ai.verta.uac.GetUsersFuzzy.Response
	16, // 22: ai.verta.uac.UACService.createUser:output_type -> ai.verta.uac.CreateUser.Response
	17, // 23: ai.verta.uac.UACService.updateUser:output_type -> ai.verta.uac.UpdateUser.Response
	18, // 24: ai.verta.uac.UACService.deleteUser:output_type -> ai.verta.uac.DeleteUser.Response

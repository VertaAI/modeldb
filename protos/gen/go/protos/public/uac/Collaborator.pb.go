...
var file_uac_Collaborator_proto_rawDesc = []byte{
	...
	0x04, 0x32, 0xe7, 0x17, 0x0a, 0x13, 0x43, 0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74,
	...
	0x73, 0x12, 0xb4, 0x01, 0x0a, 0x2b, 0x67, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x69, 0x6e, 0x67, 0x4f, 0x72, 0x67, 0x61, 0x6e,
	...
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x69,
	0x6e, 0x67, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x12, 0x75, 0x0a, 0x0b, 0x73, 0x65, 0x74, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x19, 0x2e, 0x61, 0x69, 0x2e, 0x76, 0x65, 0x72,
	0x74, 0x61, 0x2e, 0x75, 0x61, 0x63, 0x2e, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x1a, 0x22, 0x2e, 0x61, 0x69, 0x2e, 0x76, 0x65, 0x72, 0x74, 0x61, 0x2e, 0x75, 0x61,
	0x63, 0x2e, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65,
	...
	0x2f, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x3a, 0x01, 0x2a, 0x12,
	0x5a, 0x0a, 0x0f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0xb1, 0x01, 0x0a, 0x1e,
...
var file_uac_Collaborator_proto_depIdxs = []int32{
	...
	7,  // 31: ai.verta.uac.CollaboratorService.getResourcesExcludingOrganizationWorkspaces:input_type -> ai.verta.uac.GetResources
	...
	14, // 50: ai.verta.uac.CollaboratorService.getResourcesExcludingOrganizationWorkspaces:output_type -> ai.verta.uac.GetResources.Response
...
type CollaboratorServiceClient interface {
	...
	GetResourcesExcludingOrganizationWorkspaces(ctx context.Context, in *GetResources, opts ...grpc.CallOption) (*GetResources_Response, error)
...
func (c *collaboratorServiceClient) GetResourcesExcludingOrganizationWorkspaces(ctx context.Context, in *GetResources, opts ...grpc.CallOption) (*GetResources_Response, error) {
	out := new(GetResources_Response)
	err := c.cc.Invoke(ctx, "/ai.verta.uac.CollaboratorService/getResourcesExcludingOrganizationWorkspaces", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CollaboratorServiceServer interface {
	...
	// The caller must have permission to GET the resource accordingly
	// gets resources that is available in personal workspace (all except organization workspace resources)
	GetResourcesExcludingOrganizationWorkspaces(context.Context, *GetResources) (*GetResources_Response, error)
	// The caller must have permission to CREATE or UPDATE the resource accordingly
...
func (*UnimplementedCollaboratorServiceServer) GetResourcesExcludingOrganizationWorkspaces(context.Context, *GetResources) (*GetResources_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetResourcesExcludingOrganizationWorkspaces not implemented")
}
...
func _CollaboratorService_GetResourcesExcludingOrganizationWorkspaces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetResources)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollaboratorServiceServer).GetResourcesExcludingOrganizationWorkspaces(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ai.verta.uac.CollaboratorService/GetResourcesExcludingOrganizationWorkspaces",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollaboratorServiceServer).GetResourcesExcludingOrganizationWorkspaces(ctx, req.(*GetResources))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CollaboratorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getResourcesExcludingOrganizationWorkspaces",
			Handler:    _CollaboratorService_GetResourcesExcludingOrganizationWorkspaces_Handler,
		},
		{

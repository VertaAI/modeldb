...
var file_uac_Collaborator_proto_rawDesc = []byte{
	...
	0x04, 0x32, 0xcf, 0x17, 0x0a, 0x13, 0x43, 0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74,
	...
	0x73, 0x12, 0x9c, 0x01, 0x0a, 0x1f, 0x67, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x49, 0x6e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6b,
	0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x2e, 0x61, 0x69, 0x2e, 0x76, 0x65, 0x72, 0x74, 0x61,
	0x2e, 0x75, 0x61, 0x63, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x2f, 0x67, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x49, 0x6e, 0x50,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x21, 0x22, 0x1c, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6f, 0x6c, 0x6c,
	0x61, 0x62, 0x6f, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x5a, 0x0a, 0x0f, 0x64, 0x65, 0x6c, 0x65, 0x74,
...
var file_uac_Collaborator_proto_depIdxs = []int32{
	...
	7,  // 31: ai.verta.uac.CollaboratorService.getResourcesInPersonalWorkspace:input_type -> ai.verta.uac.GetResources
	...
	14, // 50: ai.verta.uac.CollaboratorService.getResourcesInPersonalWorkspace:output_type -> ai.verta.uac.GetResources.Response
...
func (c *collaboratorServiceClient) GetResourcesInPersonalWorkspace(ctx context.Context, in *GetResources, opts ...grpc.CallOption) (*GetResources_Response, error) {
	out := new(GetResources_Response)
	err := c.cc.Invoke(ctx, "/ai.verta.uac.CollaboratorService/getResourcesInPersonalWorkspace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCollaboratorServiceServer) GetResourcesInPersonalWorkspace(context.Context, *GetResources) (*GetResources_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetResourcesInPersonalWorkspace not implemented")
}
...
func _CollaboratorService_GetResourcesInPersonalWorkspace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetResources)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollaboratorServiceServer).GetResourcesInPersonalWorkspace(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ai.verta.uac.CollaboratorService/GetResourcesInPersonalWorkspace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollaboratorServiceServer).GetResourcesInPersonalWorkspace(ctx, req.(*GetResources))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CollaboratorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getResourcesInPersonalWorkspace",
			Handler:    _CollaboratorService_GetResourcesInPersonalWorkspace_Handler,
		},
		{

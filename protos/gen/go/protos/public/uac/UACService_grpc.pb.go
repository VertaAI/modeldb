...
// All implementations must embed UnimplementedUACServiceServer
...
type UACServiceServer interface {
	...
	mustEmbedUnimplementedUACServiceServer()
}

// UnimplementedUACServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedUACServiceServer) mustEmbedUnimplementedUACServiceServer() {}

// UnsafeUACServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to UACServiceServer will
// result in compilation errors.
type UnsafeUACServiceServer interface {
	mustEmbedUnimplementedUACServiceServer()
}

func RegisterUACServiceServer(s grpc.ServiceRegistrar, srv UACServiceServer) {
	s.RegisterService(&UACService_ServiceDesc, srv)
}
...
// UACService_ServiceDesc is the grpc.ServiceDesc for UACService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var UACService_ServiceDesc = grpc.ServiceDesc{

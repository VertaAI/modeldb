...
func request_UserServiceV2_UserExists_0(ctx context.Context, marshaler runtime.Marshaler, client UserServiceV2Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UserExists
	var metadata runtime.ServerMetadata
...
func local_request_UserServiceV2_UserExists_0(ctx context.Context, marshaler runtime.Marshaler, server UserServiceV2Server, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UserExists
	var metadata runtime.ServerMetadata
...
func request_UserServiceV2_ChangeCurrentUserPassword_0(ctx context.Context, marshaler runtime.Marshaler, client UserServiceV2Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ChangeCurrentUserPassword
	var metadata runtime.ServerMetadata
...
func local_request_UserServiceV2_ChangeCurrentUserPassword_0(ctx context.Context, marshaler runtime.Marshaler, server UserServiceV2Server, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ChangeCurrentUserPassword
	var metadata runtime.ServerMetadata
...
func RegisterUserServiceV2HandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserServiceV2Server) error {
	...
	mux.Handle("POST", pattern_UserServiceV2_UserExists_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_UserServiceV2_UserExists_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_UserServiceV2_UserExists_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_UserServiceV2_ChangeCurrentUserPassword_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_UserServiceV2_ChangeCurrentUserPassword_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_UserServiceV2_ChangeCurrentUserPassword_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUserServiceV2HandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserServiceV2Client) error {
	...
	mux.Handle("POST", pattern_UserServiceV2_UserExists_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UserServiceV2_UserExists_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_UserServiceV2_ChangeCurrentUserPassword_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UserServiceV2_ChangeCurrentUserPassword_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_UserServiceV2_UserExists_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v2", "userExists"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_UserServiceV2_ChangeCurrentUserPassword_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v2", "changeCurrentUserPassword"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_UserServiceV2_UserExists_0 = runtime.ForwardResponseMessage

	forward_UserServiceV2_ChangeCurrentUserPassword_0 = runtime.ForwardResponseMessage
)

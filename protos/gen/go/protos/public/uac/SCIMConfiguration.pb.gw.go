...
func RegisterSCIMConfigurationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SCIMConfigurationServiceServer) error {
	...
	mux.Handle("GET", pattern_SCIMConfigurationService_GetConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SCIMConfigurationService_GetConfiguration_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_SCIMConfigurationService_GetConfiguration_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterSCIMConfigurationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SCIMConfigurationServiceClient) error {
	...
	mux.Handle("GET", pattern_SCIMConfigurationService_GetConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SCIMConfigurationService_GetConfiguration_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_SCIMConfigurationService_GetConfiguration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "scim", "getConfiguration"}, "", runtime.AssumeColonVerbOpt(true)))
)

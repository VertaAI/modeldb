...
var file_uac_Workspace_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x56, 0x69, 0x73, 0x69, 0x62, 0x6c,
	0x65, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x22, 0x43, 0x0a, 0x0a, 0x57,
	0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x09, 0x77, 0x6f, 0x72,
	0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x61,
	...
	0x32, 0x8d, 0x04, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53, 0x65,
...
var file_uac_Workspace_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_uac_Workspace_proto_goTypes = []interface{}{
	...
	(*GetVisibleWorkspaces)(nil),                // 4: ai.verta.uac.GetVisibleWorkspaces
	(*Workspaces)(nil),                          // 5: ai.verta.uac.Workspaces
	(common.WorkspaceTypeEnum_WorkspaceType)(0), // 6: ai.verta.common.WorkspaceTypeEnum.WorkspaceType
}
var file_uac_Workspace_proto_depIdxs = []int32{
	6, // 0: ai.verta.uac.GetWorkspaceByLegacyId.workspace_type:type_name -> ai.verta.common.WorkspaceTypeEnum.WorkspaceType
	3, // 1: ai.verta.uac.Workspaces.workspace:type_name -> ai.verta.uac.Workspace
	0, // 2: ai.verta.uac.WorkspaceService.getWorkspaceById:input_type -> ai.verta.uac.GetWorkspaceById
	1, // 3: ai.verta.uac.WorkspaceService.getWorkspaceByName:input_type -> ai.verta.uac.GetWorkspaceByName
	2, // 4: ai.verta.uac.WorkspaceService.getWorkspaceByLegacyId:input_type -> ai.verta.uac.GetWorkspaceByLegacyId
	4, // 5: ai.verta.uac.WorkspaceService.getVisibleWorkspaces:input_type -> ai.verta.uac.GetVisibleWorkspaces
	3, // 6: ai.verta.uac.WorkspaceService.getWorkspaceById:output_type -> ai.verta.uac.Workspace
	3, // 7: ai.verta.uac.WorkspaceService.getWorkspaceByName:output_type -> ai.verta.uac.Workspace
	3, // 8: ai.verta.uac.WorkspaceService.getWorkspaceByLegacyId:output_type -> ai.verta.uac.Workspace
	5, // 9: ai.verta.uac.WorkspaceService.getVisibleWorkspaces:output_type -> ai.verta.uac.Workspaces

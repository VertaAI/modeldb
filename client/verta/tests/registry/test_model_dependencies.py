...
def test_list_class_functions(dependency_testing_model) -> None:
    ...
    extracted_func_names = [
        f.__name__ for f in md.list_class_functions(dependency_testing_model)
    ]
...
def test_list_modules_in_function_body_wrapped(dependency_testing_model) -> None:
    ...
    extracted_modules: Set[str] = md.list_modules_in_function_body(func)
...
def test_list_modules_in_function_signature_wrapped(dependency_testing_model) -> None:
    ...
    extracted_modules: Set[str] = md.list_modules_in_function_signature(func)
    assert extracted_modules == expected_modules
...
def test_list_class_module_names(dependency_testing_model) -> None:
    ...
    extracted_modules: Set[str] =  md.list_class_module_names(dependency_testing_model)

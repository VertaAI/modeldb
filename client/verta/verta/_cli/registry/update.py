...
@click.option("--label", "-t", multiple=True, help="Label to be associated with the object.")
@click.option("--workspace", "-w", help="Workspace to use.")
def update_model(name, label, visibility, workspace):
...
def update_model_version(type, model_name, label):

...
class Client(object):
    ...
    def get_or_create_repository(self, name=None, workspace=None, id=None, public_within_org=None, visibility=None):
        ...
        if name is not None and id is not None:
            ...
            if workspace is None:
                ...
                workspace = self._conn.get_personal_workspace()
            else:
    ...
    @property
    def endpoints(self):
        return Endpoints(self._conn, self._conf, self._conn.get_personal_workspace())
    ...
    def download_endpoint_manifest(
        ...
        data = {
            ...
            'workspace_name': workspace or self._conn.get_personal_workspace(),
        }

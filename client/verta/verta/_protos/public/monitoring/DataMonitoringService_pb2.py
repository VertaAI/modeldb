...
_FINDMONITOREDENTITYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attribute_keys', full_name='ai.verta.monitoring.FindMonitoredEntityRequest.attribute_keys', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attribute_values', full_name='ai.verta.monitoring.FindMonitoredEntityRequest.attribute_values', index=7,

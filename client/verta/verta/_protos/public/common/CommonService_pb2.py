...
_MODELDBRESOURCEENUM_MODELDBSERVICERESOURCETYPES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MONITORED_ENTITY_VERSION', index=12, number=12,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,

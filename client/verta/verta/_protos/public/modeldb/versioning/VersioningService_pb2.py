...
_VERSIONINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\311\001\022~/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch}ZG\022E/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch}'),
  ),
  _descriptor.MethodDescriptor(
    name='SetBranch',
    ...
    serialized_options=_b('\202\323\344\223\002\341\001\032~/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch}:\ncommit_shaZS\032E/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch}:\ncommit_sha'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteBranch',
    ...
    serialized_options=_b('\202\323\344\223\002\311\001*~/v1/versioning/workspaces/{repository_id.named_id.workspace_name}/repositories/{repository_id.named_id.name}/branches/{branch}ZG*E/v1/versioning/repositories/{repository_id.repo_id}/branches/{branch}'),
  ),
  _descriptor.MethodDescriptor(
    name='ListCommitsLog',

...
_BLOB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='ai.verta.modeldb.versioning.Blob.attributes', index=4,
...
_BLOB.fields_by_name['attributes'].message_type = common_dot_CommonService__pb2._KEYVALUE
...
_FINDREPOSITORIESBLOBS.fields_by_name['predicates'].message_type = modeldb_dot_CommonService__pb2._KEYVALUEQUERY

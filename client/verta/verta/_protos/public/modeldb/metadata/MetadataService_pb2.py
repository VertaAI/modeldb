...
_GENERATERANDOMNAMEREQUEST_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='ai.verta.modeldb.metadata.GenerateRandomNameRequest.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ai.verta.modeldb.metadata.GenerateRandomNameRequest.Response.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATERANDOMNAMEREQUEST = _descriptor.Descriptor(
  name='GenerateRandomNameRequest',
  full_name='ai.verta.modeldb.metadata.GenerateRandomNameRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
  ...
  nested_types=[_GENERATERANDOMNAMEREQUEST_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_GENERATERANDOMNAMEREQUEST_RESPONSE.containing_type = _GENERATERANDOMNAMEREQUEST
...
DESCRIPTOR.message_types_by_name['GenerateRandomNameRequest'] = _GENERATERANDOMNAMEREQUEST
...
GenerateRandomNameRequest = _reflection.GeneratedProtocolMessageType('GenerateRandomNameRequest', (_message.Message,), {

  'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
    'DESCRIPTOR' : _GENERATERANDOMNAMEREQUEST_RESPONSE,
    '__module__' : 'modeldb.metadata.MetadataService_pb2'
    # @@protoc_insertion_point(class_scope:ai.verta.modeldb.metadata.GenerateRandomNameRequest.Response)
    })
  ,
  'DESCRIPTOR' : _GENERATERANDOMNAMEREQUEST,
  '__module__' : 'modeldb.metadata.MetadataService_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.modeldb.metadata.GenerateRandomNameRequest)
  })
_sym_db.RegisterMessage(GenerateRandomNameRequest)
_sym_db.RegisterMessage(GenerateRandomNameRequest.Response)
...
_METADATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='ai.verta.modeldb.metadata.MetadataService.GenerateRandomName',
    index=11,
    containing_service=None,
    input_type=_GENERATERANDOMNAMEREQUEST,
    output_type=_GENERATERANDOMNAMEREQUEST_RESPONSE,
    serialized_options=b'\202\323\344\223\002!\022\037/v1/metadata/generateRandomName',
  ),
])

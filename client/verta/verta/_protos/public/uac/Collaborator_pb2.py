...
_COLLABORATORSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getResourcesInPersonalWorkspace',
    full_name='ai.verta.uac.CollaboratorService.getResourcesInPersonalWorkspace',
    index=1,
    containing_service=None,
    input_type=_GETRESOURCES,
    output_type=_GETRESOURCES_RESPONSE,
    serialized_options=b'\202\323\344\223\0022\0220/v1/collaborator/getResourcesInPersonalWorkspace',
  ),
  _descriptor.MethodDescriptor(
    name='setResource',

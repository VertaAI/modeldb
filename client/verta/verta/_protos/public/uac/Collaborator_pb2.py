...
_GETCOLLABORATOR_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.GetCollaborator.Response.total_records', index=1,
...
_GETCOLLABORATOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.GetCollaborator.pagination', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETRESOURCES_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.GetResources.Response.total_records', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETRESOURCES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.GetResources.pagination', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='owner_ids', full_name='ai.verta.uac.GetResources.owner_ids', index=5,
...
_RESOURCEADMINS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.ResourceAdmins.total_records', index=2,
...
_GETRESOURCEADMINS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.GetResourceAdmins.pagination', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETCOLLABORATOR.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
...
_GETRESOURCES.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
...
_GETRESOURCEADMINS.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
...
_COLLABORATORSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='addOrUpdateEndpointCollaboratorCommonService',
    full_name='ai.verta.uac.CollaboratorService.addOrUpdateEndpointCollaboratorCommonService',
    index=19,
    containing_service=None,
    input_type=_ADDCOLLABORATORREQUEST,
    output_type=_ADDCOLLABORATORREQUEST_RESPONSE,
    serialized_options=b'\202\323\344\223\002B\"=/v1/collaborator/addOrUpdateEndpointCollaboratorCommonService:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='removeEndpointCollaboratorCommonService',
    full_name='ai.verta.uac.CollaboratorService.removeEndpointCollaboratorCommonService',
    index=20,
    containing_service=None,
    input_type=_REMOVECOLLABORATOR,
    output_type=_REMOVECOLLABORATOR_RESPONSE,
    serialized_options=b'\202\323\344\223\002:*8/v1/collaborator/removeEndpointCollaboratorCommonService',
  ),
  _descriptor.MethodDescriptor(
    name='getEndpointCollaboratorsCommonService',
    full_name='ai.verta.uac.CollaboratorService.getEndpointCollaboratorsCommonService',
    index=21,
    containing_service=None,
    input_type=_GETCOLLABORATOR,
    output_type=_GETCOLLABORATOR_RESPONSE,
    serialized_options=b'\202\323\344\223\0028\0226/v1/collaborator/getEndpointCollaboratorsCommonService',
  ),
  _descriptor.MethodDescriptor(

...
_COLLABORATORSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getResourcesExcludingOrganizationWorkspaces',
    full_name='ai.verta.uac.CollaboratorService.getResourcesExcludingOrganizationWorkspaces',
    index=1,
    containing_service=None,
    input_type=_GETRESOURCES,
    output_type=_GETRESOURCES_RESPONSE,
    serialized_options=b'\202\323\344\223\002>\022</v1/collaborator/getResourcesExcludingOrganizationWorkspaces',
  ),
  _descriptor.MethodDescriptor(
    name='setResource',

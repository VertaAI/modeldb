...
_ORGADMINV2 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='email_address', full_name='ai.verta.uac.OrgAdminV2.email_address', index=0,

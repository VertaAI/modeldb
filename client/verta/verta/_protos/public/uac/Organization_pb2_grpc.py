...
class OrganizationService(object):
    ...
    def getOrganizationById(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/getOrganizationById',
            uac_dot_Organization__pb2.GetOrganizationById.SerializeToString,
            uac_dot_Organization__pb2.GetOrganizationById.Response.FromString,
    ...
    def getOrganizationByName(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/getOrganizationByName',
            uac_dot_Organization__pb2.GetOrganizationByName.SerializeToString,
            uac_dot_Organization__pb2.GetOrganizationByName.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def getOrganizationByShortName(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/getOrganizationByShortName',
            uac_dot_Organization__pb2.GetOrganizationByShortName.SerializeToString,
            uac_dot_Organization__pb2.GetOrganizationByShortName.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def listOrganizations(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/listOrganizations',
            uac_dot_Organization__pb2.ListOrganizations.SerializeToString,
            uac_dot_Organization__pb2.ListOrganizations.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def listMyOrganizations(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/listMyOrganizations',
            uac_dot_Organization__pb2.ListMyOrganizations.SerializeToString,
            uac_dot_Organization__pb2.ListMyOrganizations.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def setOrganization(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/setOrganization',
            uac_dot_Organization__pb2.SetOrganization.SerializeToString,
            uac_dot_Organization__pb2.SetOrganization.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def deleteOrganization(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/deleteOrganization',
            uac_dot_Organization__pb2.DeleteOrganization.SerializeToString,
            uac_dot_Organization__pb2.DeleteOrganization.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def listTeams(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/listTeams',
            uac_dot_Organization__pb2.ListTeams.SerializeToString,
            uac_dot_Organization__pb2.ListTeams.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def listUsers(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/listUsers',
            uac_dot_Organization__pb2.ListUsers.SerializeToString,
            uac_dot_Organization__pb2.ListUsers.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def addUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/addUser',
            uac_dot_Organization__pb2.AddUser.SerializeToString,
            uac_dot_Organization__pb2.AddUser.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def removeUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/removeUser',
            uac_dot_Organization__pb2.RemoveUser.SerializeToString,
            uac_dot_Organization__pb2.RemoveUser.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def addAdmins(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/addAdmins',
            uac_dot_Organization__pb2.ModifyOrganizationAdmins.SerializeToString,
    ...
    def removeAdmins(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai.verta.uac.OrganizationService/removeAdmins',
            uac_dot_Organization__pb2.ModifyOrganizationAdmins.SerializeToString,
            uac_dot_UACService__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

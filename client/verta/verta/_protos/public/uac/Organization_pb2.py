...
_ORGANIZATIONBASELINEPERMISSIONS_BASELINEPERMISSIONS = _descriptor.EnumDescriptor(
  name='BaselinePermissions',
  full_name='ai.verta.uac.OrganizationBaselinePermissions.BaselinePermissions',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_ORGANIZATIONBASELINEPERMISSIONS_BASELINEPERMISSIONS)
...
_ORGANIZATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='idp', full_name='ai.verta.uac.Organization.idp', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='created_timestamp', full_name='ai.verta.uac.Organization.created_timestamp', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updated_timestamp', full_name='ai.verta.uac.Organization.updated_timestamp', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_collaborator_type', full_name='ai.verta.uac.Organization.global_collaborator_type', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_can_deploy', full_name='ai.verta.uac.Organization.global_can_deploy', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_repo_collaborator_type', full_name='ai.verta.uac.Organization.default_repo_collaborator_type', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_endpoint_collaborator_type', full_name='ai.verta.uac.Organization.default_endpoint_collaborator_type', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoint_can_predict', full_name='ai.verta.uac.Organization.endpoint_can_predict', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_dataset_collaborator_type', full_name='ai.verta.uac.Organization.default_dataset_collaborator_type', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_registered_model_collaborator_type', full_name='ai.verta.uac.Organization.default_registered_model_collaborator_type', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='workspace_id', full_name='ai.verta.uac.Organization.workspace_id', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='registered_model_can_deploy', full_name='ai.verta.uac.Organization.registered_model_can_deploy', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_monitored_entity_collaborator_type', full_name='ai.verta.uac.Organization.default_monitored_entity_collaborator_type', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_notification_channel_collaborator_type', full_name='ai.verta.uac.Organization.default_notification_channel_collaborator_type', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='admins', full_name='ai.verta.uac.Organization.admins', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='baseline_permissions', full_name='ai.verta.uac.Organization.baseline_permissions', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='namespace', full_name='ai.verta.uac.Organization.namespace', index=21,
...
_ORGANIZATIONBASELINEPERMISSIONS = _descriptor.Descriptor(
  name='OrganizationBaselinePermissions',
  full_name='ai.verta.uac.OrganizationBaselinePermissions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='minimum_resources_permission', full_name='ai.verta.uac.OrganizationBaselinePermissions.minimum_resources_permission', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='project_can_deploy', full_name='ai.verta.uac.OrganizationBaselinePermissions.project_can_deploy', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='registry_can_deploy', full_name='ai.verta.uac.OrganizationBaselinePermissions.registry_can_deploy', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoint_can_predict', full_name='ai.verta.uac.OrganizationBaselinePermissions.endpoint_can_predict', index=3,
  ...
  nested_types=[],
  enum_types=[
    _ORGANIZATIONBASELINEPERMISSIONS_BASELINEPERMISSIONS,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_ORGANIZATIONADMINS = _descriptor.Descriptor(
  name='OrganizationAdmins',
  full_name='ai.verta.uac.OrganizationAdmins',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_ids', full_name='ai.verta.uac.OrganizationAdmins.user_ids', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='team_ids', full_name='ai.verta.uac.OrganizationAdmins.team_ids', index=1,
...
_MODIFYORGANIZATIONADMINS = _descriptor.Descriptor(
  name='ModifyOrganizationAdmins',
  full_name='ai.verta.uac.ModifyOrganizationAdmins',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='org_id', full_name='ai.verta.uac.ModifyOrganizationAdmins.org_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_ids', full_name='ai.verta.uac.ModifyOrganizationAdmins.user_ids', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='team_ids', full_name='ai.verta.uac.ModifyOrganizationAdmins.team_ids', index=2,
...
_LISTORGANIZATIONS_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='ai.verta.uac.ListOrganizations.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='organizations', full_name='ai.verta.uac.ListOrganizations.Response.organizations', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.ListOrganizations.Response.total_records', index=1,
...
_LISTORGANIZATIONS = _descriptor.Descriptor(
  ...
  full_name='ai.verta.uac.ListOrganizations',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='externalOnly', full_name='ai.verta.uac.ListOrganizations.externalOnly', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.ListOrganizations.pagination', index=1,
  ...
  nested_types=[_LISTORGANIZATIONS_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LISTMYORGANIZATIONS_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.ListMyOrganizations.Response.total_records', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTMYORGANIZATIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.ListMyOrganizations.pagination', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTUSERS_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.ListUsers.Response.total_records', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTUSERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.ListUsers.pagination', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTTEAMS_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_records', full_name='ai.verta.uac.ListTeams.Response.total_records', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTTEAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_only', full_name='ai.verta.uac.ListTeams.external_only', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pagination', full_name='ai.verta.uac.ListTeams.pagination', index=2,
...
_ORGANIZATION.fields_by_name['idp'].message_type = uac_dot_UACService__pb2._IDSERVICEPROVIDERENUM
...
_ORGANIZATION.fields_by_name['endpoint_can_predict'].enum_type = common_dot_CommonService__pb2._TERNARYENUM_TERNARY
...
_ORGANIZATION.fields_by_name['default_monitored_entity_collaborator_type'].enum_type = common_dot_CommonService__pb2._COLLABORATORTYPEENUMWITHDEFAULTENUM_COLLABORATORTYPEENUMWITHDEFAULT
_ORGANIZATION.fields_by_name['default_notification_channel_collaborator_type'].enum_type = common_dot_CommonService__pb2._COLLABORATORTYPEENUMWITHDEFAULTENUM_COLLABORATORTYPEENUMWITHDEFAULT
_ORGANIZATION.fields_by_name['admins'].message_type = _ORGANIZATIONADMINS
_ORGANIZATION.fields_by_name['baseline_permissions'].message_type = _ORGANIZATIONBASELINEPERMISSIONS
_ORGANIZATIONBASELINEPERMISSIONS.fields_by_name['minimum_resources_permission'].enum_type = _ORGANIZATIONBASELINEPERMISSIONS_BASELINEPERMISSIONS
_ORGANIZATIONBASELINEPERMISSIONS.fields_by_name['project_can_deploy'].enum_type = common_dot_CommonService__pb2._TERNARYENUM_TERNARY
_ORGANIZATIONBASELINEPERMISSIONS.fields_by_name['registry_can_deploy'].enum_type = common_dot_CommonService__pb2._TERNARYENUM_TERNARY
_ORGANIZATIONBASELINEPERMISSIONS.fields_by_name['endpoint_can_predict'].enum_type = common_dot_CommonService__pb2._TERNARYENUM_TERNARY
_ORGANIZATIONBASELINEPERMISSIONS_BASELINEPERMISSIONS.containing_type = _ORGANIZATIONBASELINEPERMISSIONS
...
_LISTORGANIZATIONS_RESPONSE.fields_by_name['organizations'].message_type = _ORGANIZATION
_LISTORGANIZATIONS_RESPONSE.containing_type = _LISTORGANIZATIONS
_LISTORGANIZATIONS.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
...
_LISTMYORGANIZATIONS.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
...
_LISTUSERS.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
_LISTTEAMS_RESPONSE.containing_type = _LISTTEAMS
_LISTTEAMS.fields_by_name['pagination'].message_type = common_dot_CommonService__pb2._PAGINATION
...
DESCRIPTOR.message_types_by_name['OrganizationBaselinePermissions'] = _ORGANIZATIONBASELINEPERMISSIONS
DESCRIPTOR.message_types_by_name['OrganizationAdmins'] = _ORGANIZATIONADMINS
DESCRIPTOR.message_types_by_name['ModifyOrganizationAdmins'] = _MODIFYORGANIZATIONADMINS
...
OrganizationBaselinePermissions = _reflection.GeneratedProtocolMessageType('OrganizationBaselinePermissions', (_message.Message,), {
  'DESCRIPTOR' : _ORGANIZATIONBASELINEPERMISSIONS,
  '__module__' : 'uac.Organization_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.uac.OrganizationBaselinePermissions)
  })
_sym_db.RegisterMessage(OrganizationBaselinePermissions)

OrganizationAdmins = _reflection.GeneratedProtocolMessageType('OrganizationAdmins', (_message.Message,), {
  'DESCRIPTOR' : _ORGANIZATIONADMINS,
  '__module__' : 'uac.Organization_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.uac.OrganizationAdmins)
  })
_sym_db.RegisterMessage(OrganizationAdmins)

ModifyOrganizationAdmins = _reflection.GeneratedProtocolMessageType('ModifyOrganizationAdmins', (_message.Message,), {
  'DESCRIPTOR' : _MODIFYORGANIZATIONADMINS,
  '__module__' : 'uac.Organization_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.uac.ModifyOrganizationAdmins)
  })
_sym_db.RegisterMessage(ModifyOrganizationAdmins)
...
ListOrganizations = _reflection.GeneratedProtocolMessageType('ListOrganizations', (_message.Message,), {

  'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
    'DESCRIPTOR' : _LISTORGANIZATIONS_RESPONSE,
    '__module__' : 'uac.Organization_pb2'
    # @@protoc_insertion_point(class_scope:ai.verta.uac.ListOrganizations.Response)
    })
  ,
  'DESCRIPTOR' : _LISTORGANIZATIONS,
  '__module__' : 'uac.Organization_pb2'
  # @@protoc_insertion_point(class_scope:ai.verta.uac.ListOrganizations)
  })
...
_ORGANIZATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='listOrganizations',
    full_name='ai.verta.uac.OrganizationService.listOrganizations',
    index=3,
    containing_service=None,
    input_type=_LISTORGANIZATIONS,
    output_type=_LISTORGANIZATIONS_RESPONSE,
    serialized_options=b'\202\323\344\223\002$\022\"/v1/organization/listOrganizations',
  ),
  _descriptor.MethodDescriptor(
    name='listMyOrganizations',
  ...
  _descriptor.MethodDescriptor(
    name='addAdmins',
    full_name='ai.verta.uac.OrganizationService.addAdmins',
    index=11,
    containing_service=None,
    input_type=_MODIFYORGANIZATIONADMINS,
    output_type=uac_dot_UACService__pb2._EMPTY,
    serialized_options=b'\202\323\344\223\002\037\"\032/v1/organization/addAdmins:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='removeAdmins',
    full_name='ai.verta.uac.OrganizationService.removeAdmins',
    index=12,
    containing_service=None,
    input_type=_MODIFYORGANIZATIONADMINS,
    output_type=uac_dot_UACService__pb2._EMPTY,
    serialized_options=b'\202\323\344\223\002\"\"\035/v1/organization/removeAdmins:\001*',
  ),
])

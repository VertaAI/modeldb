...
_ORGANIZATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_can_predict', full_name='ai.verta.uac.Organization.global_can_predict', index=11,
...
_ORGANIZATION.fields_by_name['global_can_predict'].enum_type = common_dot_CommonService__pb2._TERNARYENUM_TERNARY

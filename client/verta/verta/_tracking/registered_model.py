    ...
    def get_or_create_version(self, name=None, desc=None, tags=None, attrs=None, id=None, time_created=None):
        ...
        if id is not None:
            ...
            return RegisteredModelVersion._get_or_create_by_name(self._conn, name,
                                                       ...
                                                       lambda name: RegisteredModelVersion._create(self._conn, self._conf, None, name, desc=desc, tags=tags, attrs=attrs, date_created=time_created, registered_model_id=self.id, registered_model_name=self.name))

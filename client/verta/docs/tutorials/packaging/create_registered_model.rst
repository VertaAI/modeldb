...
Labels can also be added after the registered model has been created with :meth:`RegisteredModel.add_label() <verta.registry._entities.model.RegisteredModel.add_label>`:

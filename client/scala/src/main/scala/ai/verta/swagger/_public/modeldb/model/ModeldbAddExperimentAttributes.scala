...
case class ModeldbAddExperimentAttributes (
  ...
  def toJson(): JValue = ModeldbAddExperimentAttributes.toJson(this)
}

object ModeldbAddExperimentAttributes {
  def toJson(obj: ModeldbAddExperimentAttributes): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbAddExperimentAttributes =
    value match {
      case JObject(fields) => {

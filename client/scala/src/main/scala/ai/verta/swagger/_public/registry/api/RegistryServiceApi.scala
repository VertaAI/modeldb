...
class RegistryServiceApi(client: HttpClient, val basePath: String = "/v1") {
  ...
  def GetModelVersion2Async(id_model_id_registered_model_id: BigInt, id_model_version_id: BigInt, id_model_id_named_id_name: Option[String]=None, id_model_id_named_id_workspace_name: Option[String]=None)(implicit ec: ExecutionContext): Future[Try[RegistryGetModelVersionRequestResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
    if (id_model_id_named_id_name.isDefined) __query.update("id.model_id.named_id.name", client.toQuery(id_model_id_named_id_name.get))
    if (id_model_id_named_id_workspace_name.isDefined) __query.update("id.model_id.named_id.workspace_name", client.toQuery(id_model_id_named_id_workspace_name.get))
    if (id_model_id_registered_model_id == null) throw new Exception("Missing required parameter \"id_model_id_registered_model_id\"")
    if (id_model_version_id == null) throw new Exception("Missing required parameter \"id_model_version_id\"")
    val body: String = null
    return client.request[String, RegistryGetModelVersionRequestResponse]("GET", basePath + s"/registry/$id_model_id_registered_model_id/versions/$id_model_version_id", __query.toMap, body, RegistryGetModelVersionRequestResponse.fromJson)
  }

  def GetModelVersion2(id_model_id_registered_model_id: BigInt, id_model_version_id: BigInt, id_model_id_named_id_name: Option[String]=None, id_model_id_named_id_workspace_name: Option[String]=None)(implicit ec: ExecutionContext): Try[RegistryGetModelVersionRequestResponse] = Await.result(GetModelVersion2Async(id_model_id_registered_model_id, id_model_version_id, id_model_id_named_id_name, id_model_id_named_id_workspace_name), Duration.Inf)
  ...
  def GetRegisteredModel2Async(id_registered_model_id: BigInt, id_named_id_name: Option[String]=None, id_named_id_workspace_name: Option[String]=None)(implicit ec: ExecutionContext): Future[Try[RegistryGetRegisteredModelRequestResponse]] = {
    ...
    if (id_registered_model_id == null) throw new Exception("Missing required parameter \"id_registered_model_id\"")
    val body: String = null
    return client.request[String, RegistryGetRegisteredModelRequestResponse]("GET", basePath + s"/registry/$id_registered_model_id", __query.toMap, body, RegistryGetRegisteredModelRequestResponse.fromJson)
  }
  ...
  def commitArtifactPartAsync(body: RegistryCommitArtifactPart, model_version_id: String)(implicit ec: ExecutionContext): Future[Try[RegistryCommitArtifactPartResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
  ...
  def commitArtifactPart(body: RegistryCommitArtifactPart, model_version_id: String)(implicit ec: ExecutionContext): Try[RegistryCommitArtifactPartResponse] = Await.result(commitArtifactPartAsync(body, model_version_id), Duration.Inf)

  def commitMultipartArtifactAsync(body: RegistryCommitMultipartArtifact, model_version_id: String)(implicit ec: ExecutionContext): Future[Try[RegistryCommitMultipartArtifactResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
    if (model_version_id == null) throw new Exception("Missing required parameter \"model_version_id\"")
    if (body == null) throw new Exception("Missing required parameter \"body\"")
  ...
  def commitMultipartArtifact(body: RegistryCommitMultipartArtifact, model_version_id: String)(implicit ec: ExecutionContext): Try[RegistryCommitMultipartArtifactResponse] = Await.result(commitMultipartArtifactAsync(body, model_version_id), Duration.Inf)

  def getCommittedArtifactPartsAsync(model_version_id: String, key: Option[String]=None)(implicit ec: ExecutionContext): Future[Try[RegistryGetCommittedArtifactPartsResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
  ...
  def getCommittedArtifactParts(model_version_id: String, key: Option[String]=None)(implicit ec: ExecutionContext): Try[RegistryGetCommittedArtifactPartsResponse] = Await.result(getCommittedArtifactPartsAsync(model_version_id, key), Duration.Inf)

  def getUrlForArtifactAsync(body: RegistryGetUrlForArtifact, model_version_id: String)(implicit ec: ExecutionContext): Future[Try[RegistryGetUrlForArtifactResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
    if (model_version_id == null) throw new Exception("Missing required parameter \"model_version_id\"")
    if (body == null) throw new Exception("Missing required parameter \"body\"")
  ...
  def getUrlForArtifact(body: RegistryGetUrlForArtifact, model_version_id: String)(implicit ec: ExecutionContext): Try[RegistryGetUrlForArtifactResponse] = Await.result(getUrlForArtifactAsync(body, model_version_id), Duration.Inf)

...
case class ModeldbDeleteExperimentRunTags (
  ...
  def toJson(): JValue = ModeldbDeleteExperimentRunTags.toJson(this)
}

object ModeldbDeleteExperimentRunTags {
  def toJson(obj: ModeldbDeleteExperimentRunTags): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbDeleteExperimentRunTags =
    value match {
      case JObject(fields) => {

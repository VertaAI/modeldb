...
class VersioningServiceApi(client: HttpClient, val basePath: String = "/v1") {
  ...
  def CreateCommit2Async(repository_id_repo_id: , body: VersioningCreateCommitRequest)(implicit ec: ExecutionContext): Future[Try[VersioningCreateCommitRequestResponse]] = {
    val __query = Map[String,String](
    )
    if (repository_id_repo_id == null) throw new Exception("Missing required parameter \"repository_id_repo_id\"")
    if (body == null) throw new Exception("Missing required parameter \"body\"")
  ...
  def CreateCommit2(repository_id_repo_id: , body: VersioningCreateCommitRequest)(implicit ec: ExecutionContext): Try[VersioningCreateCommitRequestResponse] = Await.result(CreateCommit2Async(repository_id_repo_id, body), Duration.Inf)
  ...
  def DeleteBranchAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, branch: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningDeleteBranchRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def DeleteBranch(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, branch: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningDeleteBranchRequestResponse] = Await.result(DeleteBranchAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, branch, repository_id_repo_id), Duration.Inf)

  def DeleteBranch2Async(repository_id_repo_id: , branch: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningDeleteBranchRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def DeleteBranch2(repository_id_repo_id: , branch: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningDeleteBranchRequestResponse] = Await.result(DeleteBranch2Async(repository_id_repo_id, branch, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def DeleteCommitAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningDeleteCommitRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def DeleteCommit(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningDeleteCommitRequestResponse] = Await.result(DeleteCommitAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, commit_sha, repository_id_repo_id), Duration.Inf)

  def DeleteCommit2Async(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningDeleteCommitRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def DeleteCommit2(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningDeleteCommitRequestResponse] = Await.result(DeleteCommit2Async(repository_id_repo_id, commit_sha, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def DeleteRepositoryAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningDeleteRepositoryRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def DeleteRepository(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningDeleteRepositoryRequestResponse] = Await.result(DeleteRepositoryAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, repository_id_repo_id), Duration.Inf)

  def DeleteRepository2Async(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningDeleteRepositoryRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def DeleteRepository2(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningDeleteRepositoryRequestResponse] = Await.result(DeleteRepository2Async(repository_id_repo_id, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def DeleteTagAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, tag: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningDeleteTagRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def DeleteTag(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, tag: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningDeleteTagRequestResponse] = Await.result(DeleteTagAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, tag, repository_id_repo_id), Duration.Inf)

  def DeleteTag2Async(repository_id_repo_id: , tag: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningDeleteTagRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def DeleteTag2(repository_id_repo_id: , tag: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningDeleteTagRequestResponse] = Await.result(DeleteTag2Async(repository_id_repo_id, tag, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def GetBranchAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, branch: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningGetBranchRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def GetBranch(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, branch: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningGetBranchRequestResponse] = Await.result(GetBranchAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, branch, repository_id_repo_id), Duration.Inf)

  def GetBranch2Async(repository_id_repo_id: , branch: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningGetBranchRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def GetBranch2(repository_id_repo_id: , branch: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningGetBranchRequestResponse] = Await.result(GetBranch2Async(repository_id_repo_id, branch, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def GetCommitAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningGetCommitRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def GetCommit2Async(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningGetCommitRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def GetCommit2(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningGetCommitRequestResponse] = Await.result(GetCommit2Async(repository_id_repo_id, commit_sha, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def GetCommitComponentAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , location: List[String])(implicit ec: ExecutionContext): Future[Try[VersioningGetCommitComponentRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id),
  ...
  def GetCommitComponent(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , location: List[String])(implicit ec: ExecutionContext): Try[VersioningGetCommitComponentRequestResponse] = Await.result(GetCommitComponentAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, commit_sha, repository_id_repo_id, location), Duration.Inf)

  def GetCommitComponent2Async(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, location: List[String])(implicit ec: ExecutionContext): Future[Try[VersioningGetCommitComponentRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name),
      "location" -> client.toQuery(location)
  ...
  def GetCommitComponent2(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, location: List[String])(implicit ec: ExecutionContext): Try[VersioningGetCommitComponentRequestResponse] = Await.result(GetCommitComponent2Async(repository_id_repo_id, commit_sha, repository_id_named_id_name, repository_id_named_id_workspace_name, location), Duration.Inf)

  def GetRepositoryAsync(id_named_id_workspace_name: String, id_named_id_name: String, id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningGetRepositoryRequestResponse]] = {
    val __query = Map[String,String](
  ...
  def GetRepository(id_named_id_workspace_name: String, id_named_id_name: String, id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningGetRepositoryRequestResponse] = Await.result(GetRepositoryAsync(id_named_id_workspace_name, id_named_id_name, id_repo_id), Duration.Inf)

  def GetRepository2Async(id_repo_id: , id_named_id_name: String, id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningGetRepositoryRequestResponse]] = {
    val __query = Map[String,String](
  ...
  def GetRepository2(id_repo_id: , id_named_id_name: String, id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningGetRepositoryRequestResponse] = Await.result(GetRepository2Async(id_repo_id, id_named_id_name, id_named_id_workspace_name), Duration.Inf)

  def GetTagAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, tag: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningGetTagRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def GetTag(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, tag: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningGetTagRequestResponse] = Await.result(GetTagAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, tag, repository_id_repo_id), Duration.Inf)

  def GetTag2Async(repository_id_repo_id: , tag: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningGetTagRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def GetTag2(repository_id_repo_id: , tag: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningGetTagRequestResponse] = Await.result(GetTag2Async(repository_id_repo_id, tag, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def ListBlobExperimentRunsAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , pagination_page_number: BigInt, pagination_page_limit: BigInt, location: List[String])(implicit ec: ExecutionContext): Future[Try[VersioningListBlobExperimentRunsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id),
  ...
  def ListBlobExperimentRuns2(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, pagination_page_number: BigInt, pagination_page_limit: BigInt, location: List[String])(implicit ec: ExecutionContext): Try[VersioningListBlobExperimentRunsRequestResponse] = Await.result(ListBlobExperimentRuns2Async(repository_id_repo_id, commit_sha, repository_id_named_id_name, repository_id_named_id_workspace_name, pagination_page_number, pagination_page_limit, location), Duration.Inf)

  def ListBranchesAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningListBranchesRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def ListBranches(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningListBranchesRequestResponse] = Await.result(ListBranchesAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, repository_id_repo_id), Duration.Inf)

  def ListBranches2Async(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningListBranchesRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def ListBranches2(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Try[VersioningListBranchesRequestResponse] = Await.result(ListBranches2Async(repository_id_repo_id, repository_id_named_id_name, repository_id_named_id_workspace_name), Duration.Inf)

  def ListCommitBlobsAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , location_prefix: List[String])(implicit ec: ExecutionContext): Future[Try[VersioningListCommitBlobsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id),
      "location_prefix" -> client.toQuery(location_prefix)
    )
  ...
  def ListCommitBlobs(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , location_prefix: List[String])(implicit ec: ExecutionContext): Try[VersioningListCommitBlobsRequestResponse] = Await.result(ListCommitBlobsAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, commit_sha, repository_id_repo_id, location_prefix), Duration.Inf)

  def ListCommitBlobs2Async(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, location_prefix: List[String])(implicit ec: ExecutionContext): Future[Try[VersioningListCommitBlobsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name),
      "location_prefix" -> client.toQuery(location_prefix)
  ...
  def ListCommitExperimentRuns2Async(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, pagination_page_number: BigInt, pagination_page_limit: BigInt)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitExperimentRunsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name),
      "pagination.page_number" -> client.toQuery(pagination_page_number),
  ...
  def ListCommitExperimentRuns2(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, pagination_page_number: BigInt, pagination_page_limit: BigInt)(implicit ec: ExecutionContext): Try[VersioningListCommitExperimentRunsRequestResponse] = Await.result(ListCommitExperimentRuns2Async(repository_id_repo_id, commit_sha, repository_id_named_id_name, repository_id_named_id_workspace_name, pagination_page_number, pagination_page_limit), Duration.Inf)

  def ListCommitsAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: , pagination_page_number: BigInt, pagination_page_limit: BigInt, commit_base: String, commit_head: String)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id),
      "pagination.page_number" -> client.toQuery(pagination_page_number),
      "pagination.page_limit" -> client.toQuery(pagination_page_limit),
  ...
  def ListCommits(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: , pagination_page_number: BigInt, pagination_page_limit: BigInt, commit_base: String, commit_head: String)(implicit ec: ExecutionContext): Try[VersioningListCommitsRequestResponse] = Await.result(ListCommitsAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, repository_id_repo_id, pagination_page_number, pagination_page_limit, commit_base, commit_head), Duration.Inf)

  def ListCommits2Async(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, pagination_page_number: BigInt, pagination_page_limit: BigInt, commit_base: String, commit_head: String)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name),
      "pagination.page_number" -> client.toQuery(pagination_page_number),
  ...
  def ListCommits2(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, pagination_page_number: BigInt, pagination_page_limit: BigInt, commit_base: String, commit_head: String)(implicit ec: ExecutionContext): Try[VersioningListCommitsRequestResponse] = Await.result(ListCommits2Async(repository_id_repo_id, repository_id_named_id_name, repository_id_named_id_workspace_name, pagination_page_number, pagination_page_limit, commit_base, commit_head), Duration.Inf)

  def ListCommitsLogAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, branch: String, repository_id_repo_id: , commit_sha: String)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitsLogRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id),
  ...
  def ListCommitsLog(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, branch: String, repository_id_repo_id: , commit_sha: String)(implicit ec: ExecutionContext): Try[VersioningListCommitsLogRequestResponse] = Await.result(ListCommitsLogAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, branch, repository_id_repo_id, commit_sha), Duration.Inf)

  def ListCommitsLog2Async(repository_id_repo_id: , branch: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, commit_sha: String)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitsLogRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name),
      "commit_sha" -> client.toQuery(commit_sha)
  ...
  def ListCommitsLog2(repository_id_repo_id: , branch: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, commit_sha: String)(implicit ec: ExecutionContext): Try[VersioningListCommitsLogRequestResponse] = Await.result(ListCommitsLog2Async(repository_id_repo_id, branch, repository_id_named_id_name, repository_id_named_id_workspace_name, commit_sha), Duration.Inf)

  def ListCommitsLog3Async(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , branch: String)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitsLogRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id),
  ...
  def ListCommitsLog3(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String, repository_id_repo_id: , branch: String)(implicit ec: ExecutionContext): Try[VersioningListCommitsLogRequestResponse] = Await.result(ListCommitsLog3Async(repository_id_named_id_workspace_name, repository_id_named_id_name, commit_sha, repository_id_repo_id, branch), Duration.Inf)

  def ListCommitsLog4Async(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, branch: String)(implicit ec: ExecutionContext): Future[Try[VersioningListCommitsLogRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name),
      "branch" -> client.toQuery(branch)
  ...
  def ListCommitsLog4(repository_id_repo_id: , commit_sha: String, repository_id_named_id_name: String, repository_id_named_id_workspace_name: String, branch: String)(implicit ec: ExecutionContext): Try[VersioningListCommitsLogRequestResponse] = Await.result(ListCommitsLog4Async(repository_id_repo_id, commit_sha, repository_id_named_id_name, repository_id_named_id_workspace_name, branch), Duration.Inf)
  ...
  def ListTagsAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Future[Try[VersioningListTagsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.repo_id" -> client.toQuery(repository_id_repo_id)
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
  ...
  def ListTags(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, repository_id_repo_id: )(implicit ec: ExecutionContext): Try[VersioningListTagsRequestResponse] = Await.result(ListTagsAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, repository_id_repo_id), Duration.Inf)

  def ListTags2Async(repository_id_repo_id: , repository_id_named_id_name: String, repository_id_named_id_workspace_name: String)(implicit ec: ExecutionContext): Future[Try[VersioningListTagsRequestResponse]] = {
    val __query = Map[String,String](
      "repository_id.named_id.name" -> client.toQuery(repository_id_named_id_name),
      "repository_id.named_id.workspace_name" -> client.toQuery(repository_id_named_id_workspace_name)
    )
  ...
  def RevertRepositoryCommitsAsync(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String)(implicit ec: ExecutionContext): Future[Try[VersioningRevertRepositoryCommitsRequestResponse]] = {
    val __query = Map[String,String](
    )
    if (repository_id_named_id_workspace_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_workspace_name\"")
    if (repository_id_named_id_name == null) throw new Exception("Missing required parameter \"repository_id_named_id_name\"")
    if (commit_sha == null) throw new Exception("Missing required parameter \"commit_sha\"")
    val body: String = null
    return client.request[String, VersioningRevertRepositoryCommitsRequestResponse]("POST", basePath + s"/versioning/workspaces/$repository_id_named_id_workspace_name/repositories/$repository_id_named_id_name/commits/$commit_sha/revert", __query, body, VersioningRevertRepositoryCommitsRequestResponse.fromJson)
  }

  def RevertRepositoryCommits(repository_id_named_id_workspace_name: String, repository_id_named_id_name: String, commit_sha: String)(implicit ec: ExecutionContext): Try[VersioningRevertRepositoryCommitsRequestResponse] = Await.result(RevertRepositoryCommitsAsync(repository_id_named_id_workspace_name, repository_id_named_id_name, commit_sha), Duration.Inf)

  def RevertRepositoryCommits2Async(repository_id_repo_id: , commit_sha: String)(implicit ec: ExecutionContext): Future[Try[VersioningRevertRepositoryCommitsRequestResponse]] = {
    val __query = Map[String,String](
    )
    if (repository_id_repo_id == null) throw new Exception("Missing required parameter \"repository_id_repo_id\"")
    if (commit_sha == null) throw new Exception("Missing required parameter \"commit_sha\"")
    val body: String = null
    return client.request[String, VersioningRevertRepositoryCommitsRequestResponse]("POST", basePath + s"/versioning/repositories/$repository_id_repo_id/commits/$commit_sha/revert", __query, body, VersioningRevertRepositoryCommitsRequestResponse.fromJson)
  }

  def RevertRepositoryCommits2(repository_id_repo_id: , commit_sha: String)(implicit ec: ExecutionContext): Try[VersioningRevertRepositoryCommitsRequestResponse] = Await.result(RevertRepositoryCommits2Async(repository_id_repo_id, commit_sha), Duration.Inf)
  ...
  def SetBranch2Async(repository_id_repo_id: , branch: String, body: String)(implicit ec: ExecutionContext): Future[Try[VersioningSetBranchRequestResponse]] = {
    val __query = Map[String,String](
    )
    if (repository_id_repo_id == null) throw new Exception("Missing required parameter \"repository_id_repo_id\"")
    if (branch == null) throw new Exception("Missing required parameter \"branch\"")
  ...
  def SetBranch2(repository_id_repo_id: , branch: String, body: String)(implicit ec: ExecutionContext): Try[VersioningSetBranchRequestResponse] = Await.result(SetBranch2Async(repository_id_repo_id, branch, body), Duration.Inf)
  ...
  def SetTag2Async(repository_id_repo_id: , tag: String, body: String)(implicit ec: ExecutionContext): Future[Try[VersioningSetTagRequestResponse]] = {
    val __query = Map[String,String](
    )
    if (repository_id_repo_id == null) throw new Exception("Missing required parameter \"repository_id_repo_id\"")
    if (tag == null) throw new Exception("Missing required parameter \"tag\"")
  ...
  def SetTag2(repository_id_repo_id: , tag: String, body: String)(implicit ec: ExecutionContext): Try[VersioningSetTagRequestResponse] = Await.result(SetTag2Async(repository_id_repo_id, tag, body), Duration.Inf)
  ...
  def UpdateRepository2Async(id_repo_id: , body: VersioningRepository)(implicit ec: ExecutionContext): Future[Try[VersioningSetRepositoryResponse]] = {
    val __query = Map[String,String](
    )
    if (id_repo_id == null) throw new Exception("Missing required parameter \"id_repo_id\"")
    if (body == null) throw new Exception("Missing required parameter \"body\"")

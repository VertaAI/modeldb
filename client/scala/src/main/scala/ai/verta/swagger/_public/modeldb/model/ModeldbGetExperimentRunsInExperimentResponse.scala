...
case class ModeldbGetExperimentRunsInExperimentResponse (
  ...
  def toJson(): JValue = ModeldbGetExperimentRunsInExperimentResponse.toJson(this)
}

object ModeldbGetExperimentRunsInExperimentResponse {
  def toJson(obj: ModeldbGetExperimentRunsInExperimentResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbGetExperimentRunsInExperimentResponse =
    value match {
      case JObject(fields) => {

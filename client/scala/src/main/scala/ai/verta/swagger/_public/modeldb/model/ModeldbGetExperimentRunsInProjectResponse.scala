...
case class ModeldbGetExperimentRunsInProjectResponse (
  ...
  def toJson(): JValue = ModeldbGetExperimentRunsInProjectResponse.toJson(this)
}

object ModeldbGetExperimentRunsInProjectResponse {
  def toJson(obj: ModeldbGetExperimentRunsInProjectResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbGetExperimentRunsInProjectResponse =
    value match {
      case JObject(fields) => {

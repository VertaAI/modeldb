...
case class ModeldbLogHyperparameterResponse (
  ...
  def toJson(): JValue = ModeldbLogHyperparameterResponse.toJson(this)
}

object ModeldbLogHyperparameterResponse {
  def toJson(obj: ModeldbLogHyperparameterResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbLogHyperparameterResponse =
    value match {
      case JObject(fields) => {

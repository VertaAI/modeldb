...
case class ModeldbAddExperimentRunTags (
  ...
  def toJson(): JValue = ModeldbAddExperimentRunTags.toJson(this)
}

object ModeldbAddExperimentRunTags {
  def toJson(obj: ModeldbAddExperimentRunTags): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbAddExperimentRunTags =
    value match {
      case JObject(fields) => {

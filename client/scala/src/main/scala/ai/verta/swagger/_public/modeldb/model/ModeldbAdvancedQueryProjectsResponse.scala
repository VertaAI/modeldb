...
case class ModeldbAdvancedQueryProjectsResponse (
  ...
  def toJson(): JValue = ModeldbAdvancedQueryProjectsResponse.toJson(this)
}

object ModeldbAdvancedQueryProjectsResponse {
  def toJson(obj: ModeldbAdvancedQueryProjectsResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbAdvancedQueryProjectsResponse =
    value match {
      case JObject(fields) => {

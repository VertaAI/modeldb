...
case class ModeldbGetChildrenExperimentRunsResponse (
  ...
  def toJson(): JValue = ModeldbGetChildrenExperimentRunsResponse.toJson(this)
}

object ModeldbGetChildrenExperimentRunsResponse {
  def toJson(obj: ModeldbGetChildrenExperimentRunsResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbGetChildrenExperimentRunsResponse =
    value match {
      case JObject(fields) => {

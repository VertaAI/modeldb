...
case class ModeldbDeleteLineageResponse (
  ...
  def toJson(): JValue = ModeldbDeleteLineageResponse.toJson(this)
}

object ModeldbDeleteLineageResponse {
  def toJson(obj: ModeldbDeleteLineageResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbDeleteLineageResponse =
    value match {
      case JObject(fields) => {

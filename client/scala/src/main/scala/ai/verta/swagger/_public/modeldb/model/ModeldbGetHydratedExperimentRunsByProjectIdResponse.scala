...
case class ModeldbGetHydratedExperimentRunsByProjectIdResponse (
  ...
  def toJson(): JValue = ModeldbGetHydratedExperimentRunsByProjectIdResponse.toJson(this)
}

object ModeldbGetHydratedExperimentRunsByProjectIdResponse {
  def toJson(obj: ModeldbGetHydratedExperimentRunsByProjectIdResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbGetHydratedExperimentRunsByProjectIdResponse =
    value match {
      case JObject(fields) => {

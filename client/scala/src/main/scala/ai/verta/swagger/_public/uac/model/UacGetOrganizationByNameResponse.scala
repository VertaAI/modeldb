...
case class UacGetOrganizationByNameResponse (
  ...
  def toJson(): JValue = UacGetOrganizationByNameResponse.toJson(this)
}

object UacGetOrganizationByNameResponse {
  def toJson(obj: UacGetOrganizationByNameResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): UacGetOrganizationByNameResponse =
    value match {
      case JObject(fields) => {

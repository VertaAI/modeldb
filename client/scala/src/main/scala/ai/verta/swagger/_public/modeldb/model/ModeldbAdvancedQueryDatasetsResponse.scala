...
case class ModeldbAdvancedQueryDatasetsResponse (
  ...
  def toJson(): JValue = ModeldbAdvancedQueryDatasetsResponse.toJson(this)
}

object ModeldbAdvancedQueryDatasetsResponse {
  def toJson(obj: ModeldbAdvancedQueryDatasetsResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbAdvancedQueryDatasetsResponse =
    value match {
      case JObject(fields) => {

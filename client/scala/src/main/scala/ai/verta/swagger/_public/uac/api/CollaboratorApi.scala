...
class CollaboratorApi(client: HttpClient, val basePath: String = "/v1") {
  ...
  def addOrUpdateRegisteredModelCollaboratorAsync(body: UacAddCollaboratorRequest)(implicit ec: ExecutionContext): Future[Try[UacAddCollaboratorRequestResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
    if (body == null) throw new Exception("Missing required parameter \"body\"")
    return client.request[UacAddCollaboratorRequest, UacAddCollaboratorRequestResponse]("POST", basePath + s"/collaborator/addOrUpdateRegisteredModelCollaborator", __query.toMap, body, UacAddCollaboratorRequestResponse.fromJson)
  }

  def addOrUpdateRegisteredModelCollaborator(body: UacAddCollaboratorRequest)(implicit ec: ExecutionContext): Try[UacAddCollaboratorRequestResponse] = Await.result(addOrUpdateRegisteredModelCollaboratorAsync(body), Duration.Inf)
  ...
  def getRegisteredModelCollaboratorsAsync(entity_id: Option[String]=None)(implicit ec: ExecutionContext): Future[Try[UacGetCollaboratorResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
    if (entity_id.isDefined) __query.update("entity_id", client.toQuery(entity_id.get))
    val body: String = null
    return client.request[String, UacGetCollaboratorResponse]("GET", basePath + s"/collaborator/getRegisteredModelCollaborators", __query.toMap, body, UacGetCollaboratorResponse.fromJson)
  }

  def getRegisteredModelCollaborators(entity_id: Option[String]=None)(implicit ec: ExecutionContext): Try[UacGetCollaboratorResponse] = Await.result(getRegisteredModelCollaboratorsAsync(entity_id), Duration.Inf)
  ...
  def removeRegisteredModelCollaboratorAsync(authz_entity_type: Option[String]=None, date_deleted: Option[BigInt]=None, entity_id: Option[String]=None, share_with: Option[String]=None)(implicit ec: ExecutionContext): Future[Try[UacRemoveCollaboratorResponse]] = {
    var __query = new mutable.HashMap[String,List[String]]
    if (entity_id.isDefined) __query.update("entity_id", client.toQuery(entity_id.get))
    if (share_with.isDefined) __query.update("share_with", client.toQuery(share_with.get))
    if (date_deleted.isDefined) __query.update("date_deleted", client.toQuery(date_deleted.get))
    if (authz_entity_type.isDefined) __query.update("authz_entity_type", client.toQuery(authz_entity_type.get))
    val body: String = null
    return client.request[String, UacRemoveCollaboratorResponse]("DELETE", basePath + s"/collaborator/removeRegisteredModelCollaborator", __query.toMap, body, UacRemoveCollaboratorResponse.fromJson)
  }

  def removeRegisteredModelCollaborator(authz_entity_type: Option[String]=None, date_deleted: Option[BigInt]=None, entity_id: Option[String]=None, share_with: Option[String]=None)(implicit ec: ExecutionContext): Try[UacRemoveCollaboratorResponse] = Await.result(removeRegisteredModelCollaboratorAsync(authz_entity_type, date_deleted, entity_id, share_with), Duration.Inf)

...
class CollaboratorApi(client: HttpClient, val basePath: String = "/v1") {
  ...
  def removeDatasetCollaboratorAsync(entity_id: String, share_with: String, date_deleted: BigInt, authz_entity_type: String)(implicit ec: ExecutionContext): Future[Try[UacRemoveCollaboratorResponse]] = {
    val __query = Map[String,String](
      "entity_id" -> client.toQuery(entity_id),
  ...
  def removeDatasetCollaborator(entity_id: String, share_with: String, date_deleted: BigInt, authz_entity_type: String)(implicit ec: ExecutionContext): Try[UacRemoveCollaboratorResponse] = Await.result(removeDatasetCollaboratorAsync(entity_id, share_with, date_deleted, authz_entity_type), Duration.Inf)

  def removeProjectCollaboratorAsync(entity_id: String, share_with: String, date_deleted: BigInt, authz_entity_type: String)(implicit ec: ExecutionContext): Future[Try[UacRemoveCollaboratorResponse]] = {
    val __query = Map[String,String](
      "entity_id" -> client.toQuery(entity_id),
      "share_with" -> client.toQuery(share_with),
      "date_deleted" -> client.toQuery(date_deleted),
  ...
  def removeProjectCollaborator(entity_id: String, share_with: String, date_deleted: BigInt, authz_entity_type: String)(implicit ec: ExecutionContext): Try[UacRemoveCollaboratorResponse] = Await.result(removeProjectCollaboratorAsync(entity_id, share_with, date_deleted, authz_entity_type), Duration.Inf)

  def removeRepositoryCollaboratorAsync(entity_id: String, share_with: String, date_deleted: BigInt, authz_entity_type: String)(implicit ec: ExecutionContext): Future[Try[UacRemoveCollaboratorResponse]] = {
    val __query = Map[String,String](
      "entity_id" -> client.toQuery(entity_id),
      "share_with" -> client.toQuery(share_with),
      "date_deleted" -> client.toQuery(date_deleted),
  ...
  def removeRepositoryCollaborator(entity_id: String, share_with: String, date_deleted: BigInt, authz_entity_type: String)(implicit ec: ExecutionContext): Try[UacRemoveCollaboratorResponse] = Await.result(removeRepositoryCollaboratorAsync(entity_id, share_with, date_deleted, authz_entity_type), Duration.Inf)

...
case class ModeldbGetExperimentRunByDatasetResponse (
  ...
  def toJson(): JValue = ModeldbGetExperimentRunByDatasetResponse.toJson(this)
}

object ModeldbGetExperimentRunByDatasetResponse {
  def toJson(obj: ModeldbGetExperimentRunByDatasetResponse): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbGetExperimentRunByDatasetResponse =
    value match {
      case JObject(fields) => {

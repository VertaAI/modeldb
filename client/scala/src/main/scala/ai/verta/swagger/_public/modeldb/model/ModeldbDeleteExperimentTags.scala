...
case class ModeldbDeleteExperimentTags (
  ...
  def toJson(): JValue = ModeldbDeleteExperimentTags.toJson(this)
}

object ModeldbDeleteExperimentTags {
  def toJson(obj: ModeldbDeleteExperimentTags): JObject = {
    new JObject(
      List[Option[JField]](
  ...
  def fromJson(value: JValue): ModeldbDeleteExperimentTags =
    value match {
      case JObject(fields) => {

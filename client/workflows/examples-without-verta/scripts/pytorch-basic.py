...
x_train, y_train = (
    torch.tensor(data["x_train"][idxs_train], dtype=torch.float),
    torch.tensor(data["y_train"][idxs_train], dtype=torch.long),
)
x_val, y_val = (
    torch.tensor(data["x_train"][idxs_val], dtype=torch.float),
    torch.tensor(data["y_train"][idxs_val], dtype=torch.long),
)
x_test, y_test = (
    torch.tensor(data["x_test"], dtype=torch.float),

...
import sortArrayByAnotherArrayKeys from 'core/features/versioning/compareCommits/view/DiffView/shared/sortArrayByAnotherArrayKeys/sortArrayByAnotherArrayKeys';

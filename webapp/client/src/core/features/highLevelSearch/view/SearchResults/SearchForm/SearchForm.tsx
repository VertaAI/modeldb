...
import useSuggestionsFromLocalStorage from 'core/features/highLevelSearch/store/useSuggestionsFromLocalStorage';
  ...
  const autocompleteProps = useAutocomplete(
    {
      ...
      onChange: (e, option, reason) => {
        if (typeof option !== 'string' && option && reason === 'select-option') {
          onChange(option);
        }
      },
      onInputChange: e => {

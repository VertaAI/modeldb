...
import { IHydratedCommit, SHA } from 'core/shared/models/Versioning/RepositoryData';
...
export type ICommitView = Pick<IHydratedCommit, 'author' | 'dateCreated' | 'message' | 'sha'> & { parentSha?: SHA };

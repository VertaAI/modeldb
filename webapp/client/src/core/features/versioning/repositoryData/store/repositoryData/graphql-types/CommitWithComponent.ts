...
export type CommitWithComponent_repository_commitByReference_getLocation = CommitWithComponent_repository_commitByReference_getLocation_CommitFolder | CommitWithComponent_repository_commitByReference_getLocation_CommitBlob;

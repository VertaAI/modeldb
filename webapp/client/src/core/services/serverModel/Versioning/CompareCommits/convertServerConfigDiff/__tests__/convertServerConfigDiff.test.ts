    ...
    describe('added diff type', () => {
        it('should convert server model to client model', () => {
            const addedHyperparameters = {
             ...
             expect(convertServerConfigDiff(addedHyperparameters as any)).toMatchSnapshot();
             expect(convertServerConfigDiff(addedHyperparametersSet as any)).toMatchSnapshot();
        });
    });

...
import { getDiffValueBorderClassname, getDiffValueBgClassname } from 'features/compareDatasets/view/shared/DiffHighlight';
...
> {
  ...
  @bind
  private renderAttribute(attribute: IAttribute, entityType: DatasetVerisonEntityType) {
    const {
      comparedAttribute: { diffInfo },
    } = this.props;
    return (
